package mx.skins.halo
{
   ...
   public class BusyCursor extends FlexSprite
   {
      ...
      public function BusyCursor(param1:IStyleManager2 = null)
      {
         ...
         _loc7_.lineTo(1 + -0.5,0 + -0.5);
         _loc7_.lineTo(1 + -0.5,5 + -0.5);
         _loc7_.lineTo(0 + -0.5,5 + -0.5);
         _loc7_.lineTo(0 + -0.5,0 + -0.5);
         _loc7_.endFill();
         ...
         _loc7_.beginFill(0);
         _loc7_.moveTo(-0.5,-0.5);
         _loc7_.lineTo(4 + -0.5,0 + -0.5);
         _loc7_.lineTo(4 + -0.5,1 + -0.5);
         _loc7_.lineTo(0 + -0.5,1 + -0.5);
         _loc7_.lineTo(0 + -0.5,0 + -0.5);
         _loc7_.endFill();
