package mx.skins.spark
{
   ...
   public class ScrollBarUpButtonSkin extends SparkSkin implements IStateClient2
   {
      ...
      private var _1261687891_ScrollBarUpButtonSkin_SolidColorStroke1:SolidColorStroke;
      ...
      public function ScrollBarUpButtonSkin()
      {
         ...
         states = [new State({
            ...
            "overrides":[new SetProperty().initializeFromObject({
               ...
               "target":"_ScrollBarUpButtonSkin_SolidColorStroke1",
               "name":"alpha",
               "value":0.2
            })]
         })];
      ...
      private function _ScrollBarUpButtonSkin_Rect1_c() : Rect
      {
         ...
         _loc1_.bottom = 0;
         _loc1_.minHeight = 17;
         _loc1_.stroke = this._ScrollBarUpButtonSkin_SolidColorStroke1_i();
      ...
      private function _ScrollBarUpButtonSkin_SolidColorStroke1_i() : SolidColorStroke
      {
         ...
         _loc1_.weight = 1;
         this._ScrollBarUpButtonSkin_SolidColorStroke1 = _loc1_;
         BindingManager.executeBindings(this,"_ScrollBarUpButtonSkin_SolidColorStroke1",this._ScrollBarUpButtonSkin_SolidColorStroke1);
         return _loc1_;
      }
      ...
      [Bindable(event="propertyChange")]
      public function get _ScrollBarUpButtonSkin_SolidColorStroke1() : SolidColorStroke
      {
         return this._1261687891_ScrollBarUpButtonSkin_SolidColorStroke1;
      }
      
      public function set _ScrollBarUpButtonSkin_SolidColorStroke1(param1:SolidColorStroke) : void
      {
         var _loc2_:Object = this._1261687891_ScrollBarUpButtonSkin_SolidColorStroke1;
         if(_loc2_ !== param1)
         {
            this._1261687891_ScrollBarUpButtonSkin_SolidColorStroke1 = param1;
            if(this.hasEventListener("propertyChange"))
            {
               this.dispatchEvent(PropertyChangeEvent.createUpdateEvent(this,"_ScrollBarUpButtonSkin_SolidColorStroke1",_loc2_,param1));
            }
         }
      }
