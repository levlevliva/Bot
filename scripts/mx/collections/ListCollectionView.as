package mx.collections
{
   ...
   public class ListCollectionView extends Proxy implements ICollectionView, IList, IMXMLObject
   {
      ...
      public function addAll(param1:IList) : void
      {
         if(this.localIndex)
         {
            this.addAllAt(param1,this.localIndex.length);
         }
         else
         {
      ...
      public function addAllAt(param1:IList, param2:int) : void
      {
         ...
         {
            _loc5_ = this.resourceManager.getString("collections","outOfBounds",[param2]);
            throw new RangeError(_loc5_);
         }
         ...
         while(_loc4_ < _loc3_)
         {
            ...
            this.addItemAt(param1.getItemAt(_loc4_),_loc6_);
            _loc4_++;
         }
      }
      ...
      public function getItemIndex(param1:Object) : int
      {
         ...
         if(this.localIndex && this.sort)
         {
            _loc4_ = this.findItem(param1,Sort.FIRST_INDEX_MODE);
            if(_loc4_ == -1)
            {
               return -1;
            }
            _loc5_ = this.findItem(param1,Sort.LAST_INDEX_MODE);
            _loc2_ = _loc4_;
            while(_loc2_ <= _loc5_)
            {
               if(this.localIndex[_loc2_] == param1)
      ...
      override flash_proxy function getProperty(param1:*) : *
      {
         ...
         if(isNaN(_loc2_))
         {
            _loc3_ = this.resourceManager.getString("collections","unknownProperty",[param1]);
            throw new Error(_loc3_);
         }
         return this.getItemAt(int(_loc2_));
      }
      ...
      override flash_proxy function setProperty(param1:*, param2:*) : void
      {
         ...
         this.setItemAt(param2,int(_loc3_));
      }
      ...
      private function addItemsToView(param1:Array, param2:int, param3:Boolean = true) : int
      {
         ...
         var _loc12_:CollectionEvent = null;
         ...
         if(this.localIndex)
         {
            ...
            while(_loc9_ < _loc8_)
            {
               ...
               if(this.filterFunction != null)
               {
                  if(this.filterFunction(_loc10_))
                  {
                     if(this.sort)
                     {
                        _loc7_ = this.findItem(_loc10_,Sort.ANY_INDEX_MODE,true);
                     }
                     else
                     {
                        _loc7_ = this.getFilteredItemIndex(_loc10_);
                     }
                     if(_loc6_)
                     {
                        _loc5_ = _loc7_;
               ...
               {
                  _loc7_ = this.localIndex.length;
                  _loc5_ = _loc7_;
               }
               if(_loc7_ != -1)
               {
                  this.localIndex.splice(_loc7_++,0,_loc10_);
                  _loc4_.push(_loc10_);
               }
               _loc9_++;
            }
         }
         if(this.sort && this.sort.unique && this.sort.compareFunction(_loc10_,this.localIndex[_loc7_]) == 0)
         {
            _loc11_ = this.resourceManager.getString("collections","incorrectAddition");
            throw new CollectionViewError(_loc11_);
         }
         ...
         {
            _loc12_ = new CollectionEvent(CollectionEvent.COLLECTION_CHANGE);
            _loc12_.kind = CollectionEventKind.ADD;
            _loc12_.location = _loc5_;
            _loc12_.items = _loc4_;
      ...
      mx_internal function getBookmark(param1:int) : ListCollectionViewBookmark
      {
         ...
         if(param1 < 0 || param1 > this.length)
         {
            _loc3_ = this.resourceManager.getString("collections","invalidIndex",[param1]);
            throw new CollectionViewError(_loc3_);
         }
         try
         {
            _loc2_ = this.getItemAt(param1);
         }
         catch(e:Error)
         {
         }
         return new ListCollectionViewBookmark(_loc2_,this,this.revision,param1);
      }
      ...
      private function handlePropertyChangeEvents(param1:Array) : void
      {
         ...
         var _loc14_:int = 0;
         var _loc15_:int = 0;
         var _loc16_:CollectionEvent = null;
         ...
         if(this.sort || this.filterFunction != null)
         {
            ...
            while(_loc5_ < param1.length)
            {
               ...
               while(_loc11_ < _loc3_.length)
               {
                  if(_loc3_[_loc11_].item == _loc9_)
                  {
                     ...
                     while(true)
                     {
                        ...
                        if(_loc12_[_loc14_].property != _loc8_.property)
                        {
                           _loc12_.push(_loc8_);
                           break loop1;
                        }
               ...
               _loc4_.move = _loc4_.move || this.filterFunction != null || !_loc8_.property || this.sort && this.sort.propertyAffectsSort(String(_loc8_.property));
               _loc5_++;
            }
            _loc2_ = [];
            _loc5_ = 0;
            ...
            while(_loc7_ < _loc2_.length)
            {
               ...
               {
                  if(_loc2_[_loc7_] == _loc3_[_loc15_].item)
                  {
                     _loc6_ = _loc6_.concat(_loc3_[_loc15_].events);
                  }
                  _loc15_++;
               }
               _loc7_++;
         ...
         if(_loc2_.length > 0)
         {
            _loc16_ = new CollectionEvent(CollectionEvent.COLLECTION_CHANGE);
            _loc16_.kind = CollectionEventKind.UPDATE;
            _loc16_.items = _loc2_;
