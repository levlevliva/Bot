package mx.core
{
   ...
   public class Container extends UIComponent implements IContainer, IDataRenderer, IFocusManagerContainer, IListItemRenderer, IRawChildrenContainer, IChildList, IVisualElementContainer, INavigatorContent
   {
      ...
      mx_internal final function get method_9() : int
      {
      ...
      mx_internal function method_11(param1:String, param2:Function, param3:Boolean = false, param4:int = 0, param5:Boolean = false) : void
      {
         super.addEventListener(param1,param2,param3,param4,param5);
      }
      ...
      mx_internal function method_12(param1:String, param2:Function, param3:Boolean = false) : void
      {
         super.removeEventListener(param1,param2,param3);
      }
      ...
      override public function addChildAt(param1:DisplayObject, param2:int) : DisplayObject
      {
         ...
         {
            method_10(param1,this._firstChildIndex + param2);
         }
      ...
      override mx_internal function fillOverlay(param1:UIComponent, param2:uint, param3:RoundedRectangle = null) : void
      {
         ...
         if(!param3)
         {
            param3 = new RoundedRectangle(_loc4_.left,_loc4_.top,unscaledWidth - _loc4_.right - _loc4_.left,unscaledHeight - _loc4_.bottom - _loc4_.top,0);
         }
      ...
      public function createDeferredContent() : void
      {
         ...
         if(_loc1_)
         {
            generateMXMLInstances(document,_loc1_);
         }
         else
         {
      ...
      private function createScrollbarsIfNeeded(param1:Rectangle) : Boolean
      {
         ...
         {
            _loc9_ = Boolean(false);
            _loc8_ = Boolean(false);
         }
