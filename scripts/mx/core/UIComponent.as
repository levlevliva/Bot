package mx.core
{
   ...
   public class UIComponent extends FlexSprite implements IAutomationObject, IChildList, IConstraintClient, IDeferredInstantiationUIComponent, IFlexDisplayObject, IFlexModule, IInvalidating, ILayoutManagerClient, IPropertyChangeNotifier, IRepeaterClient, IStateClient, IAdvancedStyleClient, IToolTipManagerClient, IUIComponent, IValidatorListener, IVisualElement
   {
      ...
      mx_internal final function get method_2082() : Number
      {
         return super.scaleX;
      }
      
      mx_internal final function set method_2082(param1:Number) : void
      {
         super.scaleX = param1;
      }
      
      mx_internal final function get method_1632() : Number
      {
         return super.scaleY;
      }
      
      mx_internal final function set method_1632(param1:Number) : void
      {
         super.scaleY = param1;
      }
      ...
      public function setVisible(param1:Boolean, param2:Boolean = false) : void
      {
         ...
         if(this.method_245 == param1)
         {
            return;
         }
         this.method_245 = param1;
         if(!param2)
         {
      ...
      public function set designLayer(param1:DesignLayer) : void
      {
         ...
         this.method_306 = !!this._designLayer?Number(this._alpha * this._designLayer.effectiveAlpha):Number(this._alpha);
         this.method_245 = !!this.designLayer?this._visible && this._designLayer.effectiveVisibility:Boolean(this._visible);
      }
      
      mx_internal final function get method_306() : Number
      {
         return super.alpha;
      }
      
      mx_internal final function set method_306(param1:Number) : void
      {
         super.alpha = param1;
      }
      
      mx_internal final function get method_294() : String
      {
         return super.blendMode;
      }
      
      mx_internal final function set method_294(param1:String) : void
      {
         super.blendMode = param1;
      }
      
      mx_internal final function set method_307(param1:Shader) : void
      {
         super.blendShader = param1;
      }
      
      mx_internal final function get method_300() : DisplayObjectContainer
      {
         return super.parent;
      }
      
      mx_internal final function get method_1605() : Number
      {
         return super.x;
      }
      
      mx_internal final function set method_1605(param1:Number) : void
      {
         super.x = param1;
      }
      
      mx_internal final function get method_474() : Number
      {
         return super.y;
      }
      
      mx_internal final function set method_474(param1:Number) : void
      {
         super.y = param1;
      }
      
      mx_internal final function get method_2857() : Number
      {
         return super.width;
      }
      
      mx_internal final function set method_2857(param1:Number) : void
      {
         super.width = param1;
      }
      
      mx_internal final function get method_1330() : Number
      {
         return super.height;
      }
      
      mx_internal final function set method_1330(param1:Number) : void
      {
         super.height = param1;
      }
      
      mx_internal final function get method_245() : Boolean
      {
         return super.visible;
      }
      
      mx_internal final function set method_245(param1:Boolean) : void
      {
      ...
      protected function get hasComplexLayoutMatrix() : Boolean
      {
         ...
         if(this._layoutFeatures == null)
         {
            _loc1_ = super.transform.matrix;
            this._hasComplexLayoutMatrix = _loc1_ && !MatrixUtil.isDeltaIdentity(_loc1_);
            return this._hasComplexLayoutMatrix;
         }
         return this._layoutFeatures.layoutMatrix && !MatrixUtil.isDeltaIdentity(this._layoutFeatures.layoutMatrix);
      }
      ...
      mx_internal final function method_536(param1:DisplayObject) : DisplayObject
      {
         return super.addChild(param1);
      }
      
      mx_internal final function method_10(param1:DisplayObject, param2:int) : DisplayObject
      {
         return super.addChildAt(param1,param2);
      }
      
      mx_internal final function method_324(param1:DisplayObject) : DisplayObject
      {
         return super.removeChild(param1);
      }
      
      mx_internal final function method_13(param1:int) : DisplayObject
      {
         return super.removeChildAt(param1);
      }
      
      mx_internal final function method_2959(param1:DisplayObject, param2:int) : void
      {
         super.setChildIndex(param1,param2);
      }
      ...
      protected function createChildren() : void
      {
         ...
         if(_loc1_ && !this.processedMXMLDescriptors)
         {
            this.generateMXMLInstances(this.document,_loc1_);
            this.processedMXMLDescriptors = true;
         }
      }
      
      protected function addMXMLChildren(param1:Array) : void
      {
      ...
      protected function commitProperties() : void
      {
         ...
         if(this.blendModeChanged)
         {
            ...
            {
               this.method_294 = this._blendMode;
            }
            else
            {
               this.blendShaderChanged = false;
               this.method_294 = BlendMode.NORMAL;
               switch(this._blendMode)
               {
                  case "color":
                     this.method_307 = new ColorShader();
                     break;
                  case "colordodge":
                     this.method_307 = new ColorDodgeShader();
                     break;
                  case "colorburn":
                     this.method_307 = new ColorBurnShader();
                     break;
                  case "exclusion":
                     this.method_307 = new ExclusionShader();
                     break;
                  case "hue":
                     this.method_307 = new HueShader();
                     break;
                  case "luminosity":
                     this.method_307 = new LuminosityShader();
                     break;
                  case "saturation":
                     this.method_307 = new SaturationShader();
                     break;
                  case "softlight":
                     this.method_307 = new SoftLightShader();
               }
            }
         }
      ...
      private function getTotalDuration(param1:IEffect) : Number
      {
         ...
         _loc2_ = _loc2_ * _loc5_ + _loc4_ * (_loc5_ - 1) + _loc6_;
         return _loc2_;
      }
      ...
      private function getTransition(param1:String, param2:String) : Transition
      {
         ...
         while(_loc5_ < this.transitions.length)
         {
            ...
            if(_loc6_.fromState == "package_1" && _loc6_.toState == "package_1" && _loc4_ < 1)
            {
               _loc3_ = _loc6_;
               _loc4_ = 1;
            }
      ...
      mx_internal function addOverlay(param1:uint, param2:RoundedRectangle = null) : void
      {
         if(!this.effectOverlay)
         {
            ...
            this.effectOverlay.method_245 = true;
      ...
      mx_internal function removeOverlay() : void
      {
         if(this.effectOverlayReferenceCount > 0 && --this.effectOverlayReferenceCount == 0 && this.effectOverlay)
         {
            ...
            {
               this.method_324(this.effectOverlay);
            }
      ...
      protected function layer_PropertyChange(param1:PropertyChangeEvent) : void
      {
         ...
         switch(param1.property)
         {
            case "effectiveVisibility":
               ...
               if(_loc2_ != this.method_245)
               {
                  this.method_245 = _loc2_;
                  break;
               }
               break;
            case "effectiveAlpha":
               _loc3_ = Number(param1.newValue) * this._alpha;
               if(_loc3_ != this.method_306)
               {
                  this.method_306 = _loc3_;
                  break;
               }
         }
      }
      ...
      protected function createInFontContext(param1:Class) : Object
      {
         ...
         var _loc8_:IFlexModuleFactory = null;
         var _loc9_:Object = null;
         this.hasFontContextBeenSaved = true;
         _loc2_ = StringUtil.trimArrayElements(this.getStyle("fontFamily"),",");
         ...
         _loc8_ = !!this.oldEmbeddedFontContext?this.oldEmbeddedFontContext:this.moduleFactory;
         _loc9_ = this.createInModuleContext(_loc8_,_loc7_);
         if(_loc9_ == null)
         {
            _loc9_ = new param1();
         }
      ...
      private function getTextFieldClassName() : String
      {
         ...
         _loc1_ = this.getStyle("textFieldClass");
      ...
      {
         var _loc1_:Class = null;
         _loc1_ = this.getStyle("textInputClass");
         if(!_loc1_ || FlexVersion.compatibilityVersion < FlexVersion.VERSION_4_0)
         {
      ...
      public function hasFontContextChanged() : Boolean
      {
         ...
         _loc1_ = StringUtil.trimArrayElements(this.getStyle("fontFamily"),",");
         _loc2_ = this.getStyle("fontWeight");
         _loc3_ = this.getStyle("fontStyle");
         _loc4_ = _loc2_ == "bold";
         _loc5_ = _loc3_ == "italic";
         _loc6_ = !!noEmbeddedFonts?null:embeddedFontRegistry.getAssociatedModuleFactory(_loc1_,_loc4_,_loc5_,this,this.moduleFactory,this.systemManager);
      ...
      public function getVisibleRect(param1:DisplayObject = null) : Rectangle
      {
         ...
         _loc2_ = !!this.method_300?this.method_300:this.parent;
         if(!_loc2_)
         {
         ...
         _loc4_ = new Rectangle(_loc3_.x,_loc3_.y,this.width,this.height);
         _loc5_ = this;
         ...
         do
         {
            ...
            {
               if(UIComponent(_loc5_).method_300)
               {
                  _loc5_ = UIComponent(_loc5_).method_300;
               }
               else
               {
      ...
      {
         var _loc1_:AdvancedLayoutFeatures = null;
         _loc1_ = new AdvancedLayoutFeatures();
         this._hasComplexLayoutMatrix = true;
      ...
      private function setTransform(param1:flash.geom.Transform) : void
      {
         ...
         var _loc3_:mx.geom.Transform = null;
         _loc2_ = this._transform as mx.geom.Transform;
         if(_loc2_)
         {
            _loc2_.target = null;
         }
         _loc3_ = param1 as mx.geom.Transform;
         if(_loc3_)
         {
            _loc3_.target = this;
         }
      ...
      mx_internal function get method_296() : flash.geom.Transform
      {
      ...
      override public function set transform(param1:flash.geom.Transform) : void
      {
         ...
         var _loc7_:mx.geom.Transform = null;
         _loc2_ = param1.matrix;
         _loc3_ = param1.matrix3D;
         _loc4_ = param1.colorTransform;
         _loc5_ = param1.perspectiveProjection;
         _loc6_ = this.is3D;
         _loc7_ = param1 as mx.geom.Transform;
         if(_loc7_)
         {
      ...
      public function setLayoutMatrix(param1:Matrix, param2:Boolean) : void
      {
         ...
         var _loc4_:Boolean = false;
         _loc3_ = !!this._layoutFeatures?this._layoutFeatures.layoutMatrix:super.transform.matrix;
         _loc4_ = this.is3D;
         this._hasComplexLayoutMatrix = true;
         if(this._layoutFeatures == null)
         {
      ...
      public function getLayoutMatrix() : Matrix
      {
         var _loc1_:Matrix = null;
         _loc1_ = super.transform.matrix;
         if(this._layoutFeatures != null || _loc1_ == null)
         {
            if(this._layoutFeatures == null)
            {
               this.initAdvancedLayoutFeatures();
