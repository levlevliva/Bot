package mx.core
{
   ...
   public class UIFTETextField extends FTETextField implements IAutomationObject, IIMESupport, IFlexModule, IInvalidating, ISimpleStyleClient, IToolTipManagerClient, IUITextField
   {
      ...
      public function validateNow() : void
      {
         ...
         {
            super.width = this.explicitWidth > 4?Number(this.explicitWidth):Number(4);
            if(this.mirror)
            {
               this.validateTransformMatrix();
            }
      ...
      public function getTextStyles() : TextFormat
      {
         ...
         if(_loc2_ == "start")
         {
            _loc2_ = direction == "ltr"?TextFormatAlign.LEFT:TextFormatAlign.RIGHT;
         }
         else if(_loc2_ == "end")
         {
            _loc2_ = direction == "ltr"?TextFormatAlign.RIGHT:TextFormatAlign.LEFT;
         }
         _loc1_.align = _loc2_;
      ...
      public function truncateToFit(param1:String = null) : Boolean
      {
         ...
         if(_loc2_ != "" && textWidth + TEXT_WIDTH_PADDING > _loc3_ + 1.0e-14)
         {
            ...
            _loc4_ = _loc2_.slice(0,Math.floor(_loc3_ / (textWidth + TEXT_WIDTH_PADDING) * _loc2_.length));
            ...
            {
               _loc6_ = _loc2_.slice(0,_loc6_.length + 1);
               super.text = _loc6_ + param1;
               if(textWidth + TEXT_WIDTH_PADDING <= _loc3_)
               {
                  _loc4_ = _loc6_;
                  continue;
               }
