         ...
         if(this.parentObj)
         {
            if(this.useRTTI)
            {
               ...
               if(this.parentObj is IEventDispatcher)
               {
                  ...
                  {
                     "warning: unable to bind to property \'" + this._propertyName + "\' on class \'" + getQualifiedClassName(this.parentObj) + "\'";
                  }
                  else
                  {
               ...
               {
                  "warning: unable to bind to property \'" + this._propertyName + "\' on class \'" + getQualifiedClassName(this.parentObj) + "\' (class is not an IEventDispatcher)";
               }
            }
