package mx.binding
{
   ...
   public class FunctionReturnWatcher extends Watcher
   {
      ...
      {
         var _loc1_:FunctionReturnWatcher = new FunctionReturnWatcher(this.functionName,this.document,this.parameterFunction,this.events,listeners,this.functionGetter);
         return _loc1_;
      }
