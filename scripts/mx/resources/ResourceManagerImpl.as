package mx.resources
{
   ...
   public class ResourceManagerImpl extends EventDispatcher implements IResourceManager
   {
      ...
      public function ResourceManagerImpl()
      {
         ...
         this.ignoreMissingBundles = _loc1_ && _loc1_.hasOwnProperty("isMXMLC");
         if(_loc1_)
         {
      ...
      public function set localeChain(param1:Array) : void
      {
         ...
         {
            if(!this.localeMap.hasOwnProperty(_loc2_))
            {
               throw new Error("Could not find compiled locale \'" + _loc2_ + "\'.");
            }
         }
         this.update();
      }
      ...
      private function installCompiledResourceBundle(param1:ApplicationDomain, param2:String, param3:String, param4:Boolean = false) : IResourceBundle
      {
         ...
         var _loc11_:ResourceBundleProxy = new ResourceBundleProxy();
         _loc11_.bundleClass = _loc10_;
         _loc11_.useWeakReference = param4;
         _loc11_.locale = param2;
         _loc11_.bundleName = param3;
         _loc8_ = _loc11_;
      ...
      private function processInfo(param1:Object, param2:Boolean) : Array
      {
         ...
         var _loc6_:Array = this.installCompiledResourceBundles(_loc4_,_loc3_,_loc5_,param2);
         if(!this.localeChain)
         {
      ...
      private function getResourceBundleInternal(param1:String, param2:String, param3:Boolean) : IResourceBundle
      {
         ...
         if(_loc6_ is Dictionary)
         {
            ...
            for(_loc8_ in _loc6_)
            {
               ...
               {
                  if(_loc8_ is ResourceBundleProxy)
                  {
                     _loc5_ = this.loadResourceBundleProxy(ResourceBundleProxy(_loc8_));
                     break;
                  }
         ...
         else if(_loc6_ is ResourceBundleProxy)
         {
            _loc5_ = this.loadResourceBundleProxy(ResourceBundleProxy(_loc6_));
         }
         else
         {
      ...
      private function loadResourceBundleProxy(param1:ResourceBundleProxy) : ResourceBundle
      {
         var _loc2_:Class = param1.bundleClass;
         var _loc3_:ResourceBundle = ResourceBundle(new _loc2_());
         _loc3_._locale = param1.locale;
         _loc3_._bundleName = param1.bundleName;
         this.addResourceBundle(_loc3_,param1.useWeakReference);
         return _loc3_;
      }
               ...
               if(_loc7_)
               {
                  ...
                  if(_loc7_ is Dictionary)
                  {
                     ...
                     for(_loc10_ in _loc7_)
                     {
                        ...
                        {
                           if(_loc10_ is ResourceBundleProxy)
                           {
                              _loc8_ = this.loadResourceBundleProxy(ResourceBundleProxy(_loc10_));
                              break;
                           }
                  ...
                  else if(_loc7_ is ResourceBundleProxy)
                  {
                     _loc8_ = this.loadResourceBundleProxy(ResourceBundleProxy(_loc7_));
                  }
                  else
                  {
