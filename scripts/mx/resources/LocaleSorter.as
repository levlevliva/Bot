...
class LocaleID
{
   ...
   {
      var _loc2_:* = null;
      var _loc1_:LocaleID = new LocaleID();
      _loc1_.lang = this.lang;
      _loc1_.script = this.script;
      _loc1_.region = this.region;
      _loc1_.extended_langs = this.extended_langs.concat();
      _loc1_.variants = this.variants.concat();
      _loc1_.extensions = {};
      for(_loc2_ in this.extensions)
      {
         if(this.extensions.hasOwnProperty(_loc2_))
         {
            _loc1_.extensions[_loc2_] = this.extensions[_loc2_].concat();
         }
      }
      _loc1_.privates = this.privates.concat();
      _loc1_.privateLangs = this.privateLangs;
      return _loc1_;
   }
