package mx.preloaders
{
   ...
   public class Preloader extends Sprite
   {
      ...
      {
         var _loc5_:IResourceManager = null;
         ...
         if(this.rslDone && (_loc3_ >= _loc4_ && _loc4_ > 0 || _loc4_ == 0 && _loc3_ > 0 || root is MovieClip && MovieClip(root).totalFrames > 2 && MovieClip(root).framesLoaded >= 2))
         {
            ...
            if(this.resourceModuleListLoader)
            {
               if(this.applicationDomain.hasDefinition("mx.resources::ResourceManager"))
               {
                  _loc7_ = Class(this.applicationDomain.getDefinition("mx.resources::ResourceManager"));
                  _loc5_ = IResourceManager(_loc7_["getInstance"]());
               }
               _loc6_ = SystemManagerGlobals.parameters["localeChain"];
               if(_loc6_ != null && _loc6_ != "")
               {
                  _loc5_.localeChain = _loc6_.split(",");
               }
            }
