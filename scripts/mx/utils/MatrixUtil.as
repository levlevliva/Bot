package mx.utils
{
   ...
   public final class MatrixUtil
   {
      ...
      private static var var_1538:QName;
      ...
      public static function fitBounds(param1:Number, param2:Number, param3:Matrix, param4:Number, param5:Number, param6:Number, param7:Number, param8:Number, param9:Number, param10:Number, param11:Number) : Point
      {
         ...
         var _loc12_:Number = param8 < MIN_MAX_TOLERANCE?Number(0):Number(param8 - MIN_MAX_TOLERANCE);
         var _loc13_:Number = param9 < MIN_MAX_TOLERANCE?Number(0):Number(param9 - MIN_MAX_TOLERANCE);
      ...
      private static function getConcatenatedMatrixHelper(param1:DisplayObject, param2:Boolean, param3:DisplayObject) : Matrix
      {
         ...
         if(var_1538 == null)
         {
            var_1538 = new QName(mx_internal,"$transform");
         }
         var _loc5_:Matrix = !!param1?param1.transform.matrix:null;
         var _loc6_:Boolean = _loc5_ != null && param1 != param3;
         while(_loc6_)
         {
            _loc7_ = param1.scrollRect;
            if(_loc7_ != null)
            {
            ...
            {
               _loc10_ = param1["moduleFactory"];
               if(_loc10_ && _loc10_ !== lastModuleFactory && "info" in _loc10_)
               {
                  _loc11_ = _loc10_["info"]()["currentDomain"];
                  if(_loc11_ && _loc11_.hasDefinition("mx.core.UIComponent"))
                  {
                     uiComponentClass = Class(_loc11_.getDefinition("mx.core.UIComponent"));
                  }
                  if(_loc11_ && _loc11_.hasDefinition("mx.flash.UIMovieClip"))
                  {
                     uiMovieClipClass = Class(_loc11_.getDefinition("mx.flash.UIMovieClip"));
                  }
                  lastModuleFactory = _loc10_;
               }
            }
            _loc8_ = uiComponentClass && param1 is uiComponentClass;
            _loc9_ = uiMovieClipClass && param1 is uiMovieClipClass;
            if(param2 && _loc8_)
            {
            ...
            {
               _loc4_.concat(param1[var_1538].matrix);
            }
            else
            {
            ...
            _loc5_ = !!param1?param1.transform.matrix:null;
            _loc6_ = _loc5_ != null && param1 != param3;
         }
         return _loc4_;
      }
   }
