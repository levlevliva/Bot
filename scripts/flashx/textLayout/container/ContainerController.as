package flashx.textLayout.container
{
   ...
   public class ContainerController implements IInteractionEventHandler, ITextLayoutFormat, ISandboxSupport
   {
      ...
      tlf_internal function gatherVisibleLines(param1:String, param2:Boolean) : void
      {
         ...
         var _loc9_:int = 0;
         var _loc10_:int = 0;
         var _loc11_:IFlowComposer = null;
         var _loc12_:int = 0;
         var _loc13_:int = 0;
         ...
         if(this._textLength != 0)
         {
            ...
            _loc5_ = param1 == BlockProgression.RL?Number(this._xScroll - _loc3_):Number(this._xScroll);
            _loc6_ = this._yScroll;
            _loc7_ = Twips.roundTo(_loc5_);
            _loc8_ = Twips.roundTo(_loc6_);
            _loc9_ = Twips.to(_loc3_);
            _loc10_ = Twips.to(_loc4_);
            _loc11_ = this.flowComposer;
            _loc12_ = _loc11_.findLineIndexAtPosition(this.absoluteStart);
            _loc13_ = _loc11_.findLineIndexAtPosition(this.absoluteStart + this._textLength - 1);
            if(this.columnCount == 1)
            {
               _loc14_ = _loc11_.getLineAt(_loc12_);
               _loc15_ = this.testLineVisible(param1,_loc7_,_loc8_,_loc9_,_loc10_,_loc14_,null) as TextLine;
               _loc12_++;
               if(_loc15_)
               {
                  if(param2)
                  {
                     _loc14_.createShape(param1,_loc15_);
                  }
                  this._linesInView.push(_loc15_);
               }
               else
               {
                  _loc17_ = _loc13_;
                  ...
                  {
                     _loc18_ = (_loc12_ + _loc17_) / 2;
                     _loc14_ = _loc11_.getLineAt(_loc18_);
                     _loc19_ = this.testLineVisible(param1,_loc7_,_loc8_,_loc9_,_loc10_,_loc14_,null);
                     _loc15_ = _loc19_ as TextLine;
                     if(_loc15_)
                     {
                        _loc20_ = _loc11_.getLineAt(_loc18_ - 1);
                        if(!(this.testLineVisible(param1,_loc7_,_loc8_,_loc9_,_loc10_,_loc20_,null) is TextLine))
                        {
                           if(param2)
                           {
                              _loc14_.createShape(param1,_loc15_);
               ...
               while(true)
               {
                  if(_loc16_ <= _loc13_)
                  {
                     _loc14_ = _loc11_.getLineAt(_loc16_);
                     _loc15_ = this.testLineVisible(param1,_loc7_,_loc8_,_loc9_,_loc10_,_loc14_,null) as TextLine;
                     if(_loc15_)
                     {
                        if(param2)
            ...
            else
            {
               ...
               {
                  _loc14_ = _loc11_.getLineAt(_loc16_);
                  if(!(_loc14_ == null || _loc14_.controller != this))
                  {
                     _loc15_ = this.oldTestLineVisible(param1,_loc7_,_loc8_,_loc9_,_loc10_,_loc14_,null);
                     if(_loc15_)
                     {
                        if(param2)
                        {
      ...
      public function getScrollDelta(param1:int) : Number
      {
         ...
         if(_loc8_)
         {
            _loc9_ = param1 < 0?Number(_loc7_.x + _loc7_.textHeight):Number(_loc7_.x - _loc7_.descent + this._compositionWidth);
            return _loc9_ - this.horizontalScrollPosition;
         }
         _loc9_ = param1 < 0?Number(_loc7_.y):Number(_loc7_.y + _loc7_.textHeight - this._compositionHeight);
      ...
      tlf_internal function updateGraphics(param1:int) : void
      {
         ...
         var _loc11_:int = !!_loc10_?int(_loc10_.absoluteStart + _loc10_.textLength):int(this.absoluteStart + this.textLength);
            ...
            else
            {
               ...
               else
               {
                  ...
                  if(_loc26_ > _loc18_ && _loc24_ == this._container)
                  {
                     ...
                     if(_loc30_.parent)
                     {
                        this.removeInlineGraphicElement(_loc4_.parent,_loc30_.parent);
                     }
                  }
                  else
                  {
         ...
         while(_loc18_ < this._floatsInContainer.length)
         {
            ...
            if(_loc5_.parent && _loc3_.indexOf(_loc5_) < 0)
            {
               this.removeInlineGraphicElement(_loc5_.parent.parent,_loc5_.parent);
            }
         }
      ...
      private function removeAndRecycleTextLines(param1:int, param2:int) : void
      {
         ...
         if(_loc5_ && (_loc5_.lastLine == _loc4_ || this.flowComposer.getControllerAt(this.flowComposer.numControllers - 1) == this))
         {
            this.releaseLinesInBlock(_loc5_);
         }
      ...
      {
         if(param2 > this._container.numChildren)
         {
            param2 = this._container.numChildren;
         }
      ...
      {
         if(null != param1 && param2.parent == param1)
         {
      ...
      {
         this.writableTextLayoutFormat().borderLeftWidth = param1;
         this.formatChanged();
      }
      ...
      {
         this.writableTextLayoutFormat().borderRightWidth = param1;
         this.formatChanged();
      }
      ...
      {
         this.writableTextLayoutFormat().borderTopWidth = param1;
         this.formatChanged();
      }
      ...
      {
         this.writableTextLayoutFormat().borderBottomWidth = param1;
         this.formatChanged();
      }
      ...
      {
         this.writableTextLayoutFormat().borderLeftColor = param1;
         this.formatChanged();
      }
      ...
      {
         this.writableTextLayoutFormat().borderRightColor = param1;
         this.formatChanged();
      }
      ...
      {
         this.writableTextLayoutFormat().borderTopColor = param1;
         this.formatChanged();
      }
      ...
      {
         this.writableTextLayoutFormat().borderBottomColor = param1;
         this.formatChanged();
      }
      ...
      {
         this.writableTextLayoutFormat().marginLeft = param1;
         this.formatChanged();
      }
      ...
      {
         this.writableTextLayoutFormat().marginRight = param1;
         this.formatChanged();
      }
      ...
      {
         this.writableTextLayoutFormat().marginTop = param1;
         this.formatChanged();
      }
      ...
      {
         this.writableTextLayoutFormat().marginBottom = param1;
         this.formatChanged();
      }
      ...
      {
         this.writableTextLayoutFormat().cellSpacing = param1;
         this.formatChanged();
      }
      ...
      {
         this.writableTextLayoutFormat().cellPadding = param1;
         this.formatChanged();
      }
      ...
      {
         this.writableTextLayoutFormat().tableWidth = param1;
         this.formatChanged();
      }
      ...
      {
         this.writableTextLayoutFormat().tableColumnWidth = param1;
         this.formatChanged();
      }
      ...
      {
         this.writableTextLayoutFormat().frame = param1;
         this.formatChanged();
      }
      ...
      {
         this.writableTextLayoutFormat().rules = param1;
         this.formatChanged();
      }
      ...
      tlf_internal function testLineVisible(param1:String, param2:int, param3:int, param4:int, param5:int, param6:TextFlowLine, param7:TextLine) : *
      {
         ...
         {
            _loc9_ = this.textFlow.getElementsByTypeName("img");
            _loc11_ = 0;
            while(_loc11_ < _loc9_.length)
            {
               _loc10_ = _loc9_[_loc11_] as InlineGraphicElement;
               if(_loc10_ && _loc10_.getAbsoluteStart() < param6.absoluteStart)
               {
                  if(param1 == BlockProgression.TB)
                  {
                     if(_loc10_.height == undefined || _loc10_.height == "auto")
                     {
                        return 2;
                     }
                  }
                  else if(_loc10_.width == undefined || _loc10_.width == "auto")
                  {
                     return 2;
                  }
                  _loc11_++;
         ...
         if(!param6.hasLineBounds())
         {
            ...
            {
               _loc12_ = this.getPlacedTextLineBounds(param7);
               if(param7.hasGraphicElement)
               {
                  _loc12_ = this.computeLineBoundsWithGraphics(param6,param7,_loc12_);
               }
               param6.cacheLineBounds(param1,_loc12_.x,_loc12_.y,_loc12_.width,_loc12_.height);
            }
         }
         var _loc8_:* = param1 == BlockProgression.TB?Boolean(this._measureHeight):Boolean(this._measureWidth)?0:param6.testLineVisible(param1,param2,param3,param4,param5);
         return _loc8_ == 0?!!param7?param7:param6.getTextLine(true):_loc8_;
      }
      
      tlf_internal function oldTestLineVisible(param1:String, param2:int, param3:int, param4:int, param5:int, param6:TextFlowLine, param7:TextLine) : TextLine
      {
         ...
         if((param1 == BlockProgression.TB?Boolean(this._measureHeight):Boolean(this._measureWidth)) || param6.oldTestLineVisible(param1,param2,param3,param4,param5))
         {
