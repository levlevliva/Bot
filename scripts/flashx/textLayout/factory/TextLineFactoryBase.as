package flashx.textLayout.factory
{
   ...
   public class TextLineFactoryBase
   {
      ...
      {
         param1--;
         var _loc3_:TextLine = this._pass0Lines[this._truncationLineIndex] as TextLine;
         while(!(param1 >= _loc3_.userData && param1 < _loc3_.userData + _loc3_.rawTextLength))
         {
            if(param1 < _loc3_.userData)
            {
               _loc3_ = this._pass0Lines[--this._truncationLineIndex] as TextLine;
            }
         }
      ...
      tlf_internal function computeLastAllowedLineIndex(param1:int) : void
      {
         ...
         if(param1 != TruncationOptions.NO_LINE_COUNT_LIMIT && param1 <= this._truncationLineIndex)
         {
            this._truncationLineIndex = param1 - 1;
         }
      }
