package spark.layouts.supportClasses
{
   ...
   public class LayoutBase extends OnDemandEventDispatcher
   {
      ...
      protected function getScrollPositionDeltaToElementHelperHelper(param1:Rectangle, param2:Rectangle, param3:Boolean = true, param4:Number = NaN, param5:Number = NaN, param6:Number = NaN, param7:Number = NaN) : Point
      {
         ...
         var _loc8_:Rectangle = this.getScrollRect();
         if(!_loc8_ || !this.target.clipAndEnableScrolling)
         {
            return null;
         }
         ...
         if(param3)
         {
            ...
            _loc9_ = Math.abs(_loc11_) < Math.abs(_loc12_)?Number(_loc11_):Number(_loc12_);
            _loc10_ = Math.abs(_loc13_) < Math.abs(_loc14_)?Number(_loc13_):Number(_loc14_);
            if(!isNaN(param4))
            {
      ...
      mx_internal function getElementNearestScrollPosition(param1:Point, param2:String = "center") : int
      {
         ...
         while(_loc6_ < _loc3_)
         {
            _loc7_ = this.getElementBounds(_loc6_);
            if(_loc7_ != null)
            {
               _loc9_ = null;
               switch(param2)
               ...
               _loc8_ = Point.distance(param1,_loc9_);
               if(_loc8_ < _loc4_)
               {
                  _loc4_ = _loc8_;
                  _loc5_ = _loc6_;
      ...
      protected function calculateDragScrollDelta(param1:DropLocation, param2:Number) : Point
      {
         ...
         param2 = param2 - this.dragScrollInitialDelay;
         var _loc9_:Number = Math.min(param2,2000) / 2000;
         _loc9_ = _loc9_ * 3;
         _loc9_ = _loc9_ + 1;
         _loc9_ = _loc9_ * (_loc9_ * this.dragScrollSpeed * this.dragScrollInterval / 50);
         ...
         if(_loc10_ != 0 && _loc5_ - _loc4_.left < _loc7_)
         {
            ...
            _loc14_ = _loc14_ * (_loc14_ * _loc9_);
         ...
         if(_loc11_ != 0 && _loc6_ - _loc4_.top < _loc8_)
         {
            ...
            _loc15_ = _loc15_ * (_loc15_ * _loc9_);
      ...
      {
         this.horizontalScrollPosition = this.horizontalScrollPosition + this._dragScrollDelta.x;
         this.verticalScrollPosition = this.verticalScrollPosition + this._dragScrollDelta.y;
      ...
      private function globalToLocal(param1:Number, param2:Number) : Point
      {
         ...
         _loc5_.x = _loc5_.x - _loc3_.x;
         _loc5_.y = _loc5_.y - _loc3_.y;
