package spark.components.supportClasses
{
   ...
   public class ButtonBarBase extends ListBase
   {
      ...
      override protected function commitProperties() : void
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         var _loc3_:ButtonBarButton = null;
         super.commitProperties();
         if(this.requireSelectionChanged && dataGroup)
         {
            this.requireSelectionChanged = false;
            _loc1_ = dataGroup.numElements;
            _loc2_ = 0;
            while(_loc2_ < _loc1_)
            {
      ...
      override protected function itemShowingCaret(param1:int, param2:Boolean) : void
      {
         ...
         if(_loc3_)
         {
            _loc4_ = focusManager && focusManager.getFocus() == this;
            _loc3_.depth = !!param2?Number(1):Number(0);
      ...
      override public function drawFocus(param1:Boolean) : void
      {
         ...
         if(_loc2_)
         {
            _loc2_.depth = !!param1?Number(1):Number(0);
      ...
      public function getButtonIndices(param1:Array, param2:String = "") : Array
      {
         if(!dataGroup || param1.length < 1 || param1 == null)
         {
            return [];
         }
         if(param2 == "" || param2 == null)
         {
            return findRowIndices(labelField,param1);
         }
         return findRowIndices(param2,param1);
      }
      
      public function setButtonEnabled(param1:String, param2:Boolean, param3:String = "") : void
      {
         this.setButtonsEnabled([param1],param2,param3);
      }
      
      public function setButtonsEnabled(param1:Array, param2:Boolean, param3:String = "") : void
      {
         var _loc5_:Array = null;
         var _loc4_:ButtonBarButton = null;
         var _loc6_:uint = 0;
         var _loc7_:uint = 0;
         _loc5_ = this.getButtonIndices(param1,param3);
         ...
         while(_loc7_ < _loc6_)
         {
            _loc4_ = dataGroup.getElementAt(_loc5_[_loc7_]) as ButtonBarButton;
      ...
      {
         var _loc2_:int = ISelectableList(dataProvider).selectedIndex;
      ...
      private function adjustCaretIndex(param1:int) : void
      {
         ...
         var _loc3_:int = dataGroup.numElements;
         if(arrowKeysWrapFocus)
         {
            setCurrentCaretIndex((caretIndex + param1 + _loc3_) % _loc3_);
         }
         else
         {
            setCurrentCaretIndex(Math.min(_loc3_ - 1,Math.max(0,caretIndex + param1)));
         }
      ...
      override protected function keyDownHandler(param1:KeyboardEvent) : void
      {
         ...
         switch(_loc2_)
         {
            ...
            case Keyboard.SPACE:
               ...
               if(_loc3_ && (!_loc3_.selected && requireSelection || !requireSelection))
               {
         ...
         switch(param1.keyCode)
         {
            case Keyboard.SPACE:
               ...
               if(!isNaN(this.pressedIndex))
               {
                  ...
                  if(_loc2_ && (!_loc2_.selected && requireSelection || !requireSelection))
                  {
