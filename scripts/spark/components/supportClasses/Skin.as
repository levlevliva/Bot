      ...
      public function beginHighlightBitmapCapture() : Boolean
      {
         ...
         while(_loc4_ < _loc2_)
         {
            if(_loc1_[_loc4_] in this)
            {
               ...
               {
                  exclusionAlphaValues[_loc4_] = (_loc5_ as UIComponent).method_306;
                  (_loc5_ as UIComponent).method_306 = 0;
               }
      ...
      public function endHighlightBitmapCapture() : Boolean
      {
         ...
         while(_loc4_ < _loc2_)
         {
            if(_loc1_[_loc4_] in this)
            {
               ...
               if(_loc5_ is UIComponent)
               {
                  (_loc5_ as UIComponent).method_306 = exclusionAlphaValues[_loc4_];
               }
               else if(_loc5_ is DisplayObject)
               {
