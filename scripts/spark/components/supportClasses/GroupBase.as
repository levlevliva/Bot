package spark.components.supportClasses
{
   ...
   public class GroupBase extends UIComponent implements IViewport
   {
      ...
      mx_internal function method_2604() : void
      {
         super.invalidateSize();
      }
      
      mx_internal function method_181() : void
      {
         super.invalidateDisplayList();
      }
         ...
         if(this.maskTypeChanged)
         {
            ...
            if(this._mask)
            {
               ...
               else if(this._maskType == MaskType.LUMINOSITY)
               {
                  ...
                  _loc6_.mode = this.calculateLuminositySettings();
      ...
      override public function globalToLocal(param1:Point) : Point
      {
         ...
         {
            _loc2_ = _layoutFeatures.stretchX;
            _loc3_ = _layoutFeatures.stretchY;
            _layoutFeatures.stretchX = 1;
            _layoutFeatures.stretchY = 1;
            applyComputedMatrix();
            _loc4_ = super.globalToLocal(param1);
            _layoutFeatures.stretchX = _loc2_;
            _layoutFeatures.stretchY = _loc3_;
            applyComputedMatrix();
            return _loc4_;
         }
