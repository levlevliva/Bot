package spark.components.supportClasses
{
   ...
   public class ListItemDragProxy extends Group
   {
      ...
      override protected function createChildren() : void
      {
         ...
         var _loc12_:IItemRenderer = null;
         ...
         var _loc4_:Number = 0;
         var _loc5_:Number = 0;
         var _loc6_:Rectangle = _loc2_.scrollRect;
         if(_loc6_)
         {
            _loc4_ = _loc6_.x;
            _loc5_ = _loc6_.y;
         ...
         {
            _loc11_ = _loc2_.getElementAt(_loc3_[_loc10_]);
            if(!(!_loc11_ || !(_loc11_ is IItemRenderer)))
            {
               if(_loc11_.is3D)
               {
                  _loc8_ = true;
               ...
               _loc12_ = this.cloneItemRenderer(IItemRenderer(_loc11_),_loc1_);
               _loc12_.width = _loc11_.width;
      ...
      private function cloneItemRenderer(param1:IItemRenderer, param2:List) : IItemRenderer
      {
         ...
         var _loc6_:IItemRenderer = _loc3_.newInstance();
         if(!_loc6_)
         {
            return null;
         }
