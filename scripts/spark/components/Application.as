package spark.components
{
   ...
   public class Application extends SkinnableContainer
   {
      ...
      public function get aspectRatio() : String
      {
         ...
         {
            _loc1_ = _loc1_ + this.softKeyboardRect.height;
         }
      ...
      override public function initialize() : void
      {
         ...
         if(this.isIOS && _loc1_ && _loc1_.stage && _loc1_.isTopLevelRoot())
         {
            ...
            _loc1_.stage.addEventListener(FullScreenEvent.FULL_SCREEN,this.stage_fullScreenHandler);
            if(_loc1_.stage.displayState == StageDisplayState.FULL_SCREEN || _loc1_.stage.displayState == StageDisplayState.FULL_SCREEN_INTERACTIVE)
            {
      ...
      protected function stage_fullScreenHandler(param1:FullScreenEvent) : void
      {
         var _loc2_:Number = NaN;
         if(stage.displayState == StageDisplayState.FULL_SCREEN || stage.displayState == StageDisplayState.FULL_SCREEN_INTERACTIVE)
         {
            _loc2_ = getStyle("osStatusBarHeight");
            if(_loc2_ > 0)
            {
               this.savedOsStatusBarHeight = _loc2_;
               setStyle("osStatusBarHeight",0);
            }
         }
         else if(this.savedOsStatusBarHeight > 0)
         {
            setStyle("osStatusBarHeight",this.savedOsStatusBarHeight);
            this.savedOsStatusBarHeight = 0;
         }
      }
      ...
      private function softKeyboardActivateHandler(param1:SoftKeyboardEvent) : void
      {
         ...
         param1.target.addEventListener(SoftKeyboardEvent.SOFT_KEYBOARD_DEACTIVATE,this.softKeyboardDeactivateHandler);
      ...
      {
         if(this._softKeyboardRect == null)
         {
