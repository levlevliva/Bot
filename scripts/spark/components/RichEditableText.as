package spark.components
{
   ...
   public class RichEditableText extends UIComponent implements IFocusManagerComponent, IIMESupport, ISystemCursorClient, IViewport, IEditableText
   {
      ...
      public function RichEditableText()
      {
         ...
         {
            this._textContainerManager.preserveSelectionOnSetText = true;
         }
      ...
      public static function getNumberOrPercentOf(param1:Object, param2:Number) : Number
      {
         ...
         if(param1 is String)
         {
            ...
            {
               _loc4_ = Number(param1.substring(0,_loc3_ - 1));
      ...
      {
         var _loc3_:ISelectionManager = null;
      ...
      override protected function commitProperties() : void
      {
         ...
         {
            _loc4_ = this._textContainerManager.horizontalScrollPosition;
            this._textContainerManager.horizontalScrollPosition = this._horizontalScrollPosition;
            dispatchPropertyChangeEvent("horizontalScrollPosition",_loc4_,this._horizontalScrollPosition);
            this.horizontalScrollPositionChanged = false;
         }
         if(this.verticalScrollPositionChanged)
         {
            _loc5_ = this._textContainerManager.verticalScrollPosition;
            this._textContainerManager.verticalScrollPosition = this._verticalScrollPosition;
            dispatchPropertyChangeEvent("verticalScrollPosition",_loc5_,this._verticalScrollPosition);
      ...
      public function getHorizontalScrollPositionDelta(param1:uint) : Number
      {
         ...
         switch(param1)
         {
            case NavigationUnit.LEFT:
               return _loc2_.left <= 0?Number(0):Number(Math.max(_loc4_,-_loc5_));
            case NavigationUnit.RIGHT:
               return _loc2_.right >= this.contentWidth?Number(0):Number(Math.min(_loc3_,_loc5_));
      ...
      public function selectRange(param1:int, param2:int) : void
      {
         ...
         var _loc4_:SelectionEvent = null;
         var _loc5_:ISelectionManager = null;
         validateProperties();
         if(this.editingMode == EditingMode.READ_ONLY)
         {
         ...
         {
            _loc5_ = this._textContainerManager.beginInteraction();
      ...
      public function getFormatOfRange(param1:Vector.<String> = null, param2:int = -1, param3:int = -1) : TextLayoutFormat
      {
         ...
         var _loc11_:ITextLayoutFormat = null;
         var _loc12_:ITextLayoutFormat = null;
         var _loc13_:ITextLayoutFormat = null;
         ...
         else
         {
            for each(_loc6_ in param1)
            {
               if(_loc6_ in _loc5_)
               {
                  _loc7_ = _loc5_[_loc6_].category;
                  if(_loc7_ == Category.CONTAINER)
                  {
                     _loc8_ = true;
                  }
         ...
         for each(_loc6_ in param1)
         {
            ...
            {
               _loc7_ = _loc5_[_loc6_].category;
               if(_loc7_ == Category.CONTAINER && _loc11_)
               {
      ...
      public function setFormatOfRange(param1:TextLayoutFormat, param2:int = -1, param3:int = -1) : void
      {
         ...
         for(_loc8_ in _loc7_)
         {
            ...
            {
               _loc9_ = _loc7_[_loc8_].category;
               if(_loc9_ == Category.CONTAINER)
               {
                  if(!_loc4_)
                  {
      ...
      private function measureTextSize(param1:Number, param2:Number = NaN) : Rectangle
      {
         ...
         {
            _loc3_.width = _loc3_.width + getStyle("fontSize");
         }
         if(isNaN(explicitWidth) && isNaN(this.widthInChars))
         {
      ...
      private function calculateFontMetrics() : void
      {
         ...
         var _loc4_:TextElement = new TextElement();
         _loc4_.elementFormat = _loc3_;
         _loc4_.text = "M";
         var _loc5_:TextBlock = new TextBlock();
         _loc5_.content = _loc4_;
         var _loc6_:ISWFContext = ISWFContext(this.embeddedFontContext);
         if(_loc6_)
         {
      ...
      private function calculateHeightInLines() : Number
      {
         ...
         {
            _loc1_ = _loc1_ + Number(_loc3_);
         }
         else
         {
            _loc1_ = _loc1_ + this.ascent;
         }
         if(_loc2_ > 1)
         {
            ...
            _loc1_ = _loc1_ + (_loc2_ - 1) * _loc4_;
         }
         _loc1_ = _loc1_ + this.descent;
         return _loc1_;
      }
      ...
      {
         var _loc1_:String = EditingMode.READ_ONLY;
         if(enabled)
         {
            if(this._editable)
            {
               _loc1_ = EditingMode.READ_WRITE;
            }
            else if(this._selectable)
            {
               _loc1_ = EditingMode.READ_SELECT;
            }
         }
      ...
      private function handlePasteOperation(param1:PasteOperation) : void
      {
         ...
         if(!_loc2_ && _loc3_.search(ALL_NEWLINES_REGEXP) == -1)
         {
            return;
         }
      ...
      private function textContainerManager_compositionCompleteHandler(param1:CompositionCompleteEvent) : void
      {
         ...
         _loc4_.width = _loc4_.width + _loc4_.x;
         _loc4_.height = _loc4_.height + _loc4_.y;
      ...
      private function textContainerManager_scrollHandler(param1:Event) : void
      {
         ...
         var _loc5_:Number = this._textContainerManager.verticalScrollPosition;
         if(_loc5_ != _loc4_)
         {
      ...
      private function textContainerManager_selectionChangeHandler(param1:SelectionEvent) : void
      {
         ...
         var _loc4_:SelectionState = param1.selectionState;
         if(_loc4_)
         {
         ...
         var _loc5_:Boolean = _loc2_ != this._selectionAnchorPosition || _loc3_ != this._selectionActivePosition;
         if(_loc5_)
         {
      ...
      {
         var _loc3_:InsertTextOperation = null;
         var _loc4_:String = null;
         var _loc5_:SelectionState = null;
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc9_:PasteOperation = null;
         var _loc10_:String = null;
         var _loc11_:FlowTextOperation = null;
         var _loc12_:TextOperationEvent = null;
         var _loc2_:FlowOperation = param1.operation;
         if(_loc2_ is InsertTextOperation)
         {
            _loc3_ = InsertTextOperation(_loc2_);
            _loc4_ = _loc3_.text;
            _loc5_ = _loc3_.deleteSelectionState;
            _loc6_ = _loc5_ == null?0:int(_loc5_.absoluteEnd - _loc5_.absoluteStart);
            if(this._restrict != null)
            {
               _loc4_ = StringUtil.restrict(_loc4_,this.restrict);
               if(_loc4_.length == 0 && _loc6_ == 0)
               {
                  param1.preventDefault();
                  return;
               }
         ...
         else if(_loc2_ is PasteOperation)
         {
            if(!this.multiline)
            {
               _loc9_ = PasteOperation(_loc2_);
               if(_loc9_.textScrap == null || _loc9_.textScrap.textFlow == null)
               {
                  return;
               }
               _loc10_ = staticPlainTextExporter.export(_loc9_.textScrap.textFlow,ConversionType.STRING_TYPE) as String;
               if(_loc10_.search(ALL_NEWLINES_REGEXP) != -1)
               {
                  _loc10_ = _loc10_.replace(ALL_NEWLINES_REGEXP,"");
                  _loc9_.textScrap = TextClipboard.importToScrap(_loc10_,TextConverter.PLAIN_TEXT_FORMAT);
               }
            }
         }
         else if(_loc2_ is DeleteTextOperation || _loc2_ is CutOperation)
         {
            _loc11_ = FlowTextOperation(_loc2_);
            if(_loc11_.absoluteStart == _loc11_.absoluteEnd)
            {
               param1.preventDefault();
               return;
            }
            if(this._displayAsPassword)
            {
               ...
               {
                  this._text = splice(this._text,_loc11_.absoluteStart,_loc11_.absoluteEnd,"");
               }
               else
               {
                  param1.preventDefault();
         ...
         {
            _loc12_ = new TextOperationEvent(TextOperationEvent.CHANGING);
            _loc12_.operation = _loc2_;
            dispatchEvent(_loc12_);
            if(_loc12_.isDefaultPrevented())
            {
               param1.preventDefault();
            }
         }
