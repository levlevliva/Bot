package spark.components
{
   ...
   public class Scroller extends SkinnableComponent implements IFocusManagerComponent, IVisualElementContainer
   {
      ...
      {
         if(!this.verticalScrollBar && this.verticalScrollBarFactory)
         {
      ...
      private function ensureElementPositionIsVisible(param1:IVisualElement, param2:Rectangle = null, param3:Boolean = true, param4:Boolean = true) : void
      {
         ...
         var _loc6_:LayoutBase = this.viewportLayout;
         if(_loc6_)
         {
            if(this.throwEffect && this.throwEffect.isPlaying)
            {
               this.throwEffect.stop();
               this.snapContentScrollPosition();
            }
            _loc7_ = _loc6_.getScrollPositionDeltaToAnyElement(param1,param2,param3);
            _loc8_ = FlexGlobals.topLevelApplication as Application;
            _loc10_ = _loc8_ && !_loc8_.resizeForSoftKeyboard && (stage && stage.softKeyboardRect.height > 0);
            if(_loc10_)
            {
               _loc9_ = _loc6_.getChildElementBounds(param1);
               ...
               if(_loc11_ >= 0 && _loc11_ < _loc12_ && _loc9_.bottom - this.viewport.verticalScrollPosition > _loc11_)
               {
                  ...
                  _loc14_ = !!_loc7_?Number(_loc7_.x):Number(0);
                  _loc7_ = new Point(_loc14_,_loc13_ - this.viewport.verticalScrollPosition);
               }
            }
            if(_loc7_)
            {
               this.viewport.horizontalScrollPosition = this.viewport.horizontalScrollPosition + _loc7_.x;
               this.viewport.verticalScrollPosition = this.viewport.verticalScrollPosition + _loc7_.y;
               if(!param2)
               {
                  if(!_loc9_)
                  {
                  ...
                  {
                     _loc15_ = IStyleClient(param1).getStyle("focusThickness");
                  }
                  if(_loc15_)
                  {
      ...
      mx_internal function snapElement(param1:int, param2:Boolean) : Animate
      {
         ...
         var _loc7_:Vector.<MotionPath> = null;
         ...
         switch(this.scrollSnappingMode)
         {
            ...
            case ScrollSnappingMode.CENTER:
               if(this.canScrollHorizontally)
               {
                  _loc5_ = _loc4_.left + _loc4_.width / 2 - this.viewport.width / 2;
                  break;
               }
               if(this.canScrollVertically)
               {
                  _loc5_ = _loc4_.top + _loc4_.height / 2 - this.viewport.height / 2;
                  break;
               }
               break;
            case ScrollSnappingMode.TRAILING_EDGE:
               if(this.canScrollHorizontally)
               {
                  _loc5_ = _loc4_.right - this.viewport.width;
                  break;
               }
               if(this.canScrollVertically)
               {
                  _loc5_ = _loc4_.bottom - this.viewport.height;
                  break;
               }
               break;
         }
      ...
      mx_internal function stopAnimations() : void
      {
         ...
         if(this.snapElementAnimation && this.snapElementAnimation.isPlaying)
         {
      ...
      {
         var _loc1_:Number = !!isNaN(this.viewport.width)?Number(0):Number(this.viewport.width);
         var _loc2_:Number = !!isNaN(this.viewport.height)?Number(0):Number(this.viewport.height);
         var _loc3_:int = 0;
      ...
      private function checkScrollPosition() : void
      {
         ...
         if(this.throwEffect && this.throwEffect.isPlaying && _loc2_)
         {
            if(_loc1_)
            {
               this.throwEffect.stop();
            ...
            {
               _loc3_ = this.throwEffect.getCurrentVelocity();
         ...
         else if(!this.inTouchInteraction)
         {
            if(_loc1_ && this.orientationChangeSnapElement != -1)
            {
               if(this.scrollSnappingMode == ScrollSnappingMode.NONE && this.pageScrollingEnabled)
               {
                  ...
                  {
                     _loc4_ = !!isNaN(this.viewport.width)?Number(0):Number(this.viewport.width);
                     _loc5_ = !!isNaN(this.viewport.height)?Number(0):Number(this.viewport.height);
                     if(this.canScrollHorizontally)
                     {
               ...
               {
                  this.snapElement(this.orientationChangeSnapElement,false);
               }
      ...
      private function determineLeadingEdgeSnappingScrollRanges() : void
      {
         ...
         var _loc4_:int = _loc1_.getElementNearestScrollPosition(new Point(0,0),"topLeft");
         var _loc5_:Rectangle = _loc1_.getElementBounds(_loc4_);
         if(this.canScrollHorizontally)
         {
            this.minHorizontalScrollPosition = _loc5_.left;
            _loc6_ = !!isNaN(this.viewport.width)?Number(0):Number(this.viewport.width);
            _loc2_ = _loc1_.getElementNearestScrollPosition(new Point(this.viewport.contentWidth - _loc6_,0),"topLeft");
            do
            {
         ...
         else if(this.canScrollVertically)
         {
            ...
            _loc7_ = !!isNaN(this.viewport.height)?Number(0):Number(this.viewport.height);
            _loc2_ = _loc1_.getElementNearestScrollPosition(new Point(0,this.viewport.contentHeight - _loc7_),"topLeft");
            do
            {
               _loc3_ = _loc1_.getElementBounds(_loc2_);
      ...
      private function determineCenterSnappingScrollRanges() : void
      {
         ...
         var _loc7_:Number = NaN;
         var _loc1_:LayoutBase = this.viewportLayout;
         _loc2_ = _loc1_.getElementNearestScrollPosition(new Point(0,0),"center");
         _loc3_ = _loc1_.getElementBounds(_loc2_);
         if(this.canScrollHorizontally)
         {
            _loc6_ = !!isNaN(this.viewport.width)?Number(0):Number(this.viewport.width);
            _loc4_ = _loc1_.getElementNearestScrollPosition(new Point(this.viewport.contentWidth,0),"center");
         ...
         {
            _loc7_ = !!isNaN(this.viewport.height)?Number(0):Number(this.viewport.height);
            _loc4_ = _loc1_.getElementNearestScrollPosition(new Point(0,this.viewport.contentHeight),"center");
            _loc5_ = _loc1_.getElementBounds(_loc4_);
      ...
      private function determineTrailingEdgeSnappingScrollRanges() : void
      {
         ...
         {
            _loc6_ = !!isNaN(this.viewport.width)?Number(0):Number(this.viewport.width);
            _loc4_ = _loc1_.getElementNearestScrollPosition(new Point(this.viewport.contentWidth,0),"bottomRight");
            _loc5_ = _loc1_.getElementBounds(_loc4_);
            this.maxHorizontalScrollPosition = _loc5_.right - _loc6_;
            _loc2_ = _loc1_.getElementNearestScrollPosition(new Point(_loc6_,0),"bottomRight");
            do
            {
               _loc3_ = _loc1_.getElementBounds(_loc2_);
         ...
         {
            _loc7_ = !!isNaN(this.viewport.height)?Number(0):Number(this.viewport.height);
            _loc4_ = _loc1_.getElementNearestScrollPosition(new Point(0,this.viewport.contentHeight),"bottomRight");
            _loc5_ = _loc1_.getElementBounds(_loc4_);
            this.maxVerticalScrollPosition = _loc5_.bottom - _loc7_;
            _loc2_ = _loc1_.getElementNearestScrollPosition(new Point(0,_loc7_),"bottomRight");
            do
            {
               _loc3_ = _loc1_.getElementBounds(_loc2_);
      ...
      private function determineScrollRanges() : void
      {
         ...
         var _loc4_:LayoutBase = null;
         this.minVerticalScrollPosition = this.maxVerticalScrollPosition = 0;
         this.minHorizontalScrollPosition = this.maxHorizontalScrollPosition = 0;
         if(this.viewport)
         {
            _loc1_ = !!isNaN(this.viewport.height)?Number(0):Number(this.viewport.height);
            _loc2_ = !!isNaN(this.viewport.width)?Number(0):Number(this.viewport.width);
            if(!this.bounceEnabled && !this.pullEnabled)
            {
               this.minVerticalScrollPosition = this.minHorizontalScrollPosition = -Number.MAX_VALUE;
            ...
            {
               this.maxVerticalScrollPosition = this.viewport.contentHeight > _loc1_?Number(this.viewport.contentHeight - _loc1_):Number(0);
               if(this.pageScrollingEnabled && this.canScrollVertically && _loc1_ != 0)
               {
                  _loc3_ = this.viewport.contentHeight % _loc1_;
                  if(_loc3_)
                  {
                     this.maxVerticalScrollPosition = this.maxVerticalScrollPosition + (_loc1_ - _loc3_);
                  }
               }
               this.maxHorizontalScrollPosition = this.viewport.contentWidth > _loc2_?Number(this.viewport.contentWidth - _loc2_):Number(0);
               if(this.pageScrollingEnabled && this.canScrollHorizontally && _loc2_ != 0)
               {
                  _loc3_ = this.viewport.contentWidth % _loc2_;
                  if(_loc3_)
                  {
                     this.maxHorizontalScrollPosition = this.maxHorizontalScrollPosition + (_loc2_ - _loc3_);
                  }
               }
            }
            else
            {
               _loc4_ = this.viewportLayout;
               if(!_loc4_ || _loc4_.target.numElements == 0)
               {
                  return;
               }
         ...
         if(this.verticalScrollBar)
         {
            this.verticalScrollBar.contentMinimum = this.minVerticalScrollPosition;
            this.verticalScrollBar.contentMaximum = this.maxVerticalScrollPosition;
         }
         if(this.horizontalScrollBar)
         {
            this.horizontalScrollBar.contentMinimum = this.minHorizontalScrollPosition;
            this.horizontalScrollBar.contentMaximum = this.maxHorizontalScrollPosition;
         }
      }
      ...
      private function viewport_propertyChangeHandler(param1:PropertyChangeEvent) : void
      {
         switch(param1.property)
         {
            ...
            case HORIZONTAL_SCROLL_POSITION:
               if(getStyle("interactionMode") == InteractionMode.TOUCH)
               {
                  if(!this.inTouchInteraction && (!this.snapElementAnimation || !this.snapElementAnimation.isPlaying))
                  {
                  ...
                  if(this.throwEffect && this.throwEffect.isPlaying && this.throwEffect.isSnapping)
                  {
                     if(Math.abs(this.viewport.horizontalScrollPosition - this.throwEffect.finalPosition.x) < 1 && Math.abs(this.viewport.verticalScrollPosition - this.throwEffect.finalPosition.y) < 1)
                     {
                        this.throwEffect.stop();
                        this.snapContentScrollPosition();
                        break;
      ...
      override protected function focusInHandler(param1:FocusEvent) : void
      {
         ...
         if(_loc2_ && this.viewport && this.ensureElementIsVisibleForSoftKeyboard)
         {
            _loc3_ = _loc2_.getFocus() as IVisualElement;
            this.lastFocusedElement = _loc3_;
         }
      }
      ...
      private function orientationChangingHandler(param1:Event) : void
      {
         ...
         {
            _loc2_ = !!isNaN(this.viewport.width)?Number(0):Number(this.viewport.width);
            _loc3_ = !!isNaN(this.viewport.height)?Number(0):Number(this.viewport.height);
      ...
      {
         var _loc1_:ScrollerLayout = this.scrollerLayout;
         if(_loc1_)
         {
            return _loc1_.canScrollHorizontally;
         }
         return false;
      }
      ...
      private function get canScrollVertically() : Boolean
      {
         ...
         if(_loc1_)
         {
            return _loc1_.canScrollVertically;
         }
         return false;
      }
      ...
      {
         var _loc3_:Number = this.pageThrowVelocityThreshold * Capabilities.screenDPI / 1000;
         if(this.canScrollHorizontally)
         {
            if(param1 < -_loc3_ || this.viewport.horizontalScrollPosition >= this.currentPageScrollPosition + this.viewport.width * this.pageDragDistanceThreshold)
            {
            ...
            else if(param1 > _loc3_ || this.viewport.horizontalScrollPosition <= this.currentPageScrollPosition - this.viewport.width * this.pageDragDistanceThreshold)
            {
               this.currentPageScrollPosition = Math.max(this.currentPageScrollPosition - this.viewport.width,this.minHorizontalScrollPosition);
            }
            this.currentPageScrollPosition = this.getSnappedPosition(this.currentPageScrollPosition,HORIZONTAL_SCROLL_POSITION);
         }
         else if(this.canScrollVertically)
         {
            if(param2 < -_loc3_ || this.viewport.verticalScrollPosition >= this.currentPageScrollPosition + this.viewport.height * this.pageDragDistanceThreshold)
            {
            ...
            else if(param2 > _loc3_ || this.viewport.verticalScrollPosition <= this.currentPageScrollPosition - this.viewport.height * this.pageDragDistanceThreshold)
            {
               this.currentPageScrollPosition = Math.max(this.currentPageScrollPosition - this.viewport.height,this.minVerticalScrollPosition);
            }
      ...
      private function setUpThrowEffect(param1:Number, param2:Number) : Boolean
      {
         ...
         if(!this.throwEffect)
         {
            this.throwEffect = new ThrowEffect();
         ...
         this.throwEffect.propertyNameX = !!this.canScrollHorizontally?HORIZONTAL_SCROLL_POSITION:null;
         this.throwEffect.propertyNameY = !!this.canScrollVertically?VERTICAL_SCROLL_POSITION:null;
         this.throwEffect.startingVelocityX = param1;
         this.throwEffect.startingVelocityY = param2;
         this.throwEffect.startingPositionX = this.viewport.horizontalScrollPosition;
         this.throwEffect.startingPositionY = this.viewport.verticalScrollPosition;
         this.throwEffect.minPositionX = _loc3_;
         this.throwEffect.minPositionY = _loc4_;
         this.throwEffect.maxPositionX = _loc5_;
         this.throwEffect.maxPositionY = _loc6_;
         this.throwEffect.decelerationFactor = this.throwEffectDecelFactor;
         this.throwEffect.finalPositionFilterFunction = this.scrollSnappingMode == ScrollSnappingMode.NONE?null:this.getSnappedPosition;
         this.throwReachedMaximumScrollPosition = false;
         if(this.throwEffect.setup())
         {
            this.throwFinalHSP = this.throwEffect.finalPosition.x;
            if(this.canScrollHorizontally && this.bounceEnabled && this.throwFinalHSP == this.maxHorizontalScrollPosition)
            {
               this.throwReachedMaximumScrollPosition = true;
            }
            this.throwFinalVSP = this.throwEffect.finalPosition.y;
            if(this.canScrollVertically && this.bounceEnabled && this.throwFinalVSP == this.maxVerticalScrollPosition)
            {
               this.throwReachedMaximumScrollPosition = true;
            }
            return true;
      ...
      private function getSnappedPosition(param1:Number, param2:String) : Number
      {
         ...
         var _loc3_:LayoutBase = this.viewportLayout;
         var _loc4_:int = -1;
         var _loc6_:Number = !!isNaN(this.viewport.width)?Number(0):Number(this.viewport.width);
         var _loc7_:Number = !!isNaN(this.viewport.height)?Number(0):Number(this.viewport.height);
         if(this.scrollSnappingMode == ScrollSnappingMode.NONE && this.pageScrollingEnabled)
         {
         ...
         if(_loc3_ && _loc3_.target.numElements > 0)
         {
            switch(this._scrollSnappingMode)
            {
               case ScrollSnappingMode.LEADING_EDGE:
                  ...
                  {
                     _loc4_ = _loc3_.getElementNearestScrollPosition(new Point(param1,0),"topLeft");
                     _loc5_ = _loc3_.getElementBounds(_loc4_);
                     param1 = _loc5_.left;
                     break;
                  }
                  if(this.canScrollVertically && param2 == VERTICAL_SCROLL_POSITION)
                  {
                     _loc4_ = _loc3_.getElementNearestScrollPosition(new Point(0,param1),"topLeft");
                     _loc5_ = _loc3_.getElementBounds(_loc4_);
                     param1 = _loc5_.top;
                     break;
                  }
               ...
               case ScrollSnappingMode.CENTER:
                  if(this.canScrollHorizontally && param2 == HORIZONTAL_SCROLL_POSITION)
                  {
                     _loc4_ = _loc3_.getElementNearestScrollPosition(new Point(param1 + _loc6_ / 2,0),"center");
                     _loc5_ = _loc3_.getElementBounds(_loc4_);
                     param1 = _loc5_.left + _loc5_.width / 2 - _loc6_ / 2;
                     break;
                  }
                  if(this.canScrollVertically && param2 == VERTICAL_SCROLL_POSITION)
                  {
                     _loc4_ = _loc3_.getElementNearestScrollPosition(new Point(0,param1 + _loc7_ / 2),"center");
                     _loc5_ = _loc3_.getElementBounds(_loc4_);
                     param1 = _loc5_.top + _loc5_.height / 2 - _loc7_ / 2;
                     break;
                  }
                  break;
               case ScrollSnappingMode.TRAILING_EDGE:
                  if(this.canScrollHorizontally && param2 == HORIZONTAL_SCROLL_POSITION)
                  {
                     _loc4_ = _loc3_.getElementNearestScrollPosition(new Point(param1 + _loc6_,0),"bottomRight");
                     _loc5_ = _loc3_.getElementBounds(_loc4_);
                     param1 = _loc5_.right - _loc6_;
                     break;
                  }
                  if(this.canScrollVertically && param2 == VERTICAL_SCROLL_POSITION)
                  {
                     _loc4_ = _loc3_.getElementNearestScrollPosition(new Point(0,param1 + _loc7_),"bottomRight");
                     _loc5_ = _loc3_.getElementBounds(_loc4_);
                     param1 = _loc5_.bottom - _loc7_;
                     break;
                  }
                  break;
            }
         ...
         if(_loc2_ || param1 == "interactionMode")
         {
            if(getStyle("interactionMode") == InteractionMode.TOUCH)
            {
               ...
               if(!this.touchScrollHelper)
               {
                  ...
                  this.touchScrollHelper.target = this;
                  this.touchScrollHelper.dragFunction = this.performDrag;
                  this.touchScrollHelper.throwFunction = this.performThrow;
               }
               if(this.horizontalScrollBar)
               {
      ...
      override protected function keyDownHandler(param1:KeyboardEvent) : void
      {
         ...
         if(this.verticalScrollBar && this.verticalScrollBar.visible)
         {
            ...
            if(!isNaN(_loc3_))
            {
               _loc2_.verticalScrollPosition = _loc2_.verticalScrollPosition + _loc3_;
         ...
         if(this.horizontalScrollBar && this.horizontalScrollBar.visible)
         {
            ...
            {
               case Keyboard.LEFT:
                  _loc4_ = layoutDirection == LayoutDirection.LTR?Number(_loc2_.getHorizontalScrollPositionDelta(NavigationUnit.LEFT)):Number(_loc2_.getHorizontalScrollPositionDelta(NavigationUnit.RIGHT));
                  break;
               case Keyboard.RIGHT:
                  _loc4_ = layoutDirection == LayoutDirection.LTR?Number(_loc2_.getHorizontalScrollPositionDelta(NavigationUnit.RIGHT)):Number(_loc2_.getHorizontalScrollPositionDelta(NavigationUnit.LEFT));
                  break;
               case Keyboard.HOME:
               ...
               case Keyboard.PAGE_UP:
                  if(!this.verticalScrollBar || !this.verticalScrollBar.visible)
                  {
                     _loc4_ = !!LayoutDirection.LTR?Number(_loc2_.getHorizontalScrollPositionDelta(NavigationUnit.LEFT)):Number(_loc2_.getHorizontalScrollPositionDelta(NavigationUnit.RIGHT));
                     break;
                  }
                  break;
               case Keyboard.PAGE_DOWN:
                  if(!this.verticalScrollBar || !this.verticalScrollBar.visible)
                  {
                     _loc4_ = !!LayoutDirection.LTR?Number(_loc2_.getHorizontalScrollPositionDelta(NavigationUnit.RIGHT)):Number(_loc2_.getHorizontalScrollPositionDelta(NavigationUnit.LEFT));
                     break;
                  }
            }
            if(!isNaN(_loc4_))
            {
               _loc2_.horizontalScrollPosition = _loc2_.horizontalScrollPosition + _loc4_;
               param1.preventDefault();
            }
         }
      }
      ...
      private function skin_mouseWheelHandler(param1:MouseEvent) : void
      {
         ...
         if(this.verticalScrollBar && this.verticalScrollBar.visible)
         {
            ...
            while(_loc7_ < _loc5_)
            {
               ...
               if(!isNaN(_loc8_))
               {
                  _loc2_.verticalScrollPosition = _loc2_.verticalScrollPosition + _loc8_;
         ...
         {
            _loc6_ = _loc4_ < 0?uint(NavigationUnit.RIGHT):uint(NavigationUnit.LEFT);
            _loc9_ = 0;
            while(_loc9_ < _loc5_)
            {
               ...
               if(!isNaN(_loc10_))
               {
                  _loc2_.horizontalScrollPosition = _loc2_.horizontalScrollPosition + _loc10_;
                  if(_loc2_ is IInvalidating)
                  {
                     IInvalidating(_loc2_).validateNow();
                  }
      ...
      {
         if(param1.relatedObject != this && this.inTouchInteraction)
         {
            param1.preventDefault();
         }
      }
      ...
      private function touchInteractionStartHandler(param1:TouchInteractionEvent) : void
      {
         ...
         else
         {
            ...
            if(this.canScrollVertically)
            {
               this.verticalScrollInProgress = true;
            }
            skin.invalidateDisplayList();
            if(this.hideScrollBarAnimation && this.hideScrollBarAnimation.isPlaying)
            {
            ...
            if(this.horizontalScrollBar)
            {
               this.horizontalScrollBar.alpha = this.maxHorizontalScrollPosition == 0 && this.minHorizontalScrollPosition == 0?Number(0):Number(1);
            }
            if(this.verticalScrollBar)
            {
               this.verticalScrollBar.alpha = this.maxVerticalScrollPosition == 0 && this.minVerticalScrollPosition == 0?Number(0):Number(1);
            }
      ...
      private function touchScrolling_captureMouseHandler(param1:MouseEvent) : void
      {
         ...
         switch(param1.type)
         {
            case MouseEvent.MOUSE_DOWN:
               _loc2_ = 0.01984;
               _loc3_ = Math.round(_loc2_ * Capabilities.screenDPI);
               ...
               if(this.captureNextMouseDown && (Math.abs(this.viewport.verticalScrollPosition - this.throwFinalVSP) > _loc3_ || Math.abs(this.viewport.horizontalScrollPosition - this.throwFinalHSP) > _loc3_))
               {
                  ...
                  this.touchScrollHelper.startScrollWatch(param1,this.canScrollHorizontally,this.canScrollVertically,Math.round(this.minSlopInches * Capabilities.screenDPI),!!dragEventThinning?Number(MAX_DRAG_RATE):Number(NaN));
      ...
      mx_internal function performDrag(param1:Number, param2:Number) : void
      {
         ...
         if(this.textSelectionAutoScrollEnabled)
         {
            this.setUpTextSelectionAutoScroll();
            return;
         }
         ...
         var _loc8_:Number = !!isNaN(this.viewport.width)?Number(0):Number(this.viewport.width);
         if(this.pullEnabled)
         {
            ...
            _loc9_ = !!isNaN(this.viewport.height)?Number(0):Number(this.viewport.height);
      ...
      mx_internal function performThrow(param1:Number, param2:Number) : void
      {
         ...
         _loc3_.x = _loc3_.x * 100000;
         _loc3_.y = _loc3_.y * 100000;
      ...
      private function hideScrollBarAnimation_effectEndHandler(param1:EffectEvent) : void
      {
         ...
         this.verticalScrollInProgress = false;
         skin.invalidateDisplayList();
      }
      ...
      mx_internal function enableTextSelectionAutoScroll(param1:Boolean, param2:int = 0, param3:int = -1, param4:int = 0, param5:int = -1) : void
      {
         if(getStyle("interactionMode") == InteractionMode.TOUCH)
         {
            this.textSelectionAutoScrollEnabled = param1;
      ...
      private function softKeyboardActivateHandler(param1:SoftKeyboardEvent) : void
      {
         ...
         this.preventThrows = true;
         var _loc2_:Rectangle = stage.softKeyboardRect;
         if(_loc2_.width > 0 && _loc2_.height > 0)
         {
            if(this.lastFocusedElement && this.ensureElementIsVisibleForSoftKeyboard && (_loc2_.height != this.oldSoftKeyboardHeight || _loc2_.width != this.oldSoftKeyboardWidth))
            {
      ...
      {
         this.adjustScrollPositionAfterSoftKeyboardDeactivate();
