package spark.components.gridClasses
{
   ...
   public class GridColumn extends EventDispatcher
   {
      ...
      {
         var _loc1_:IAdvancedStyleClient = null;
         if(this.dataTipFormatterStyleParentInvalid && this.grid)
         {
            _loc1_ = this._dataTipFormatter as IAdvancedStyleClient;
            if(_loc1_ && _loc1_.styleParent != this.grid)
            {
      ...
      public function set dataTipFormatter(param1:IFormatter) : void
      {
         ...
         if(this.grid && this._dataTipFormatter)
         {
            _loc2_ = this._dataTipFormatter as IAdvancedStyleClient;
            if(_loc2_ && _loc2_.styleParent == this.grid)
            {
      ...
      {
         var _loc1_:IAdvancedStyleClient = null;
         if(this.formatterStyleParentInvalid && this.grid)
         {
      ...
      {
         return this.showDataTips === undefined?this.grid && this.grid.showDataTips:Boolean(this.showDataTips);
      }
      ...
      mx_internal function itemToString(param1:Object, param2:Array, param3:Function, param4:IFormatter) : String
      {
