package spark.components
{
   ...
   public class Label extends TextBase
   {
      ...
      override mx_internal function composeTextLines(param1:Number = NaN, param2:Number = NaN) : Boolean
      {
         ...
         if(text != null && text.length > 0 && maxDisplayedLines && !this.doesComposedTextFit(param2,param1,_loc3_,maxDisplayedLines,_loc4_))
         {
      ...
      private function createElementFormat() : ElementFormat
      {
         ...
         if(_loc1_ != null)
         {
            if(_loc1_ == "auto")
            {
               _loc1_ = !!this.embeddedFontContext?FontLookup.EMBEDDED_CFF:FontLookup.DEVICE;
            }
            else if(_loc1_ == FontLookup.EMBEDDED_CFF && !this.embeddedFontContext)
            {
               _loc1_ = FontLookup.DEVICE;
            }
         ...
         if(_loc1_ != null)
         {
            if(_loc1_ == "auto")
            {
               _loc1_ = TextBaseline.ROMAN;
               _loc4_ = getStyle("locale");
               if(_loc4_ != null)
               {
                  _loc5_ = _loc4_.toLowerCase();
                  if(_loc5_.indexOf("ja") == 0 || _loc5_.indexOf("zh") == 0)
                  {
      ...
      private function createTextLines(param1:ElementFormat) : Boolean
      {
         ...
         {
            _loc3_ = "space";
            _loc9_ = getStyle("locale");
            if(_loc9_ != null)
            {
               _loc10_ = _loc9_.toLowerCase();
               if(_loc10_.indexOf("ja") == 0 || _loc10_.indexOf("zh") == 0)
               {
                  _loc3_ = "eastAsian";
               }
            }
         ...
         if(_loc5_ == "justify")
         {
            _loc8_ = _loc6_ == "justify"?LineJustification.ALL_INCLUDING_LAST:LineJustification.ALL_BUT_LAST;
         }
         else
         {
            _loc8_ = LineJustification.UNJUSTIFIED;
         }
         if(_loc3_ == "space")
         {
      ...
      private function createTextLinesFromTextBlock(param1:TextBlock, param2:Vector.<DisplayObject>, param3:Rectangle) : Boolean
      {
         ...
         var _loc41_:TextLine = null;
         var _loc49_:int = 0;
         var _loc50_:Number = NaN;
         var _loc51_:TextLine = null;
         var _loc52_:ElementFormat = null;
         var _loc53_:FontMetrics = null;
         var _loc54_:Shape = null;
         var _loc55_:Graphics = null;
         ...
         var _loc18_:Boolean = isNaN(_loc16_);
         if(_loc18_)
         {
            _loc16_ = maxWidth;
         }
         var _loc19_:Number = _loc5_ == "explicit"?Number(TextLine.MAX_LINE_WIDTH):Number(_loc16_);
         ...
         else if(_loc6_ is String)
         {
            ...
            _loc50_ = Number(String(_loc6_).substring(0,_loc49_ - 1));
            _loc21_ = _loc50_ / 100 * _loc20_;
         }
         if(isNaN(_loc21_))
         {
            _loc21_ = 1.2 * _loc20_;
         ...
         while(true)
         {
            _loc51_ = TextLineRecycler.getLineForReuse();
            if(_loc51_)
            {
               if(_loc28_)
               {
            ...
            _loc26_ = _loc26_ + (_loc24_ == 0?_loc25_.ascent:_loc21_);
            ...
            _loc27_ = _loc25_;
            param2[_loc56_] = _loc27_;
            _loc27_.y = _loc26_;
            _loc22_ = Math.max(_loc22_,_loc27_.textWidth);
            _loc23_ = _loc23_ + _loc27_.textHeight;
         ...
         var _loc34_:Number = param3.left + _loc9_;
         var _loc35_:Number = _loc34_ + _loc16_ / 2;
         var _loc36_:Number = _loc34_ + _loc16_;
         var _loc37_:Number = param3.top + _loc11_;
         var _loc38_:Number = _loc17_ - (_loc27_.y + _loc27_.descent);
         var _loc39_:Number = _loc38_ / 2;
         _loc38_ = _loc38_ + _loc37_;
         _loc39_ = _loc39_ + _loc37_;
         ...
         while(_loc48_ < _loc24_)
         {
            ...
            {
               _loc27_.y = _loc27_.y + _loc37_;
            }
            else if(_loc15_ == "middle")
            {
               _loc27_.y = _loc27_.y + _loc39_;
            }
            else if(_loc15_ == "bottom")
            {
               _loc27_.y = _loc27_.y + _loc38_;
            }
            else if(_loc15_ == "justify")
            {
               _loc42_ = _loc42_ + (_loc48_ == 0?_loc37_ + _loc27_.ascent:_loc41_.descent + _loc40_ + _loc27_.ascent);
               _loc27_.y = _loc42_;
               _loc41_ = _loc27_;
            }
      ...
      private function doesComposedTextFit(param1:Number, param2:Number, param3:Boolean, param4:int, param5:String) : Boolean
      {
         ...
         if(param4 != -1 && textLines.length > param4)
         {
            return false;
         }
         if(param5 == "explicit")
         {
            if(bounds.right > param2)
            {
               return false;
            }
         }
         if(textLines.length <= 1 || isNaN(param1))
         {
            return true;
         }
         var _loc6_:TextLine = TextLine(textLines[textLines.length - 1]);
         var _loc7_:Number = _loc6_.y + _loc6_.descent;
      ...
      private function truncateText(param1:Number, param2:Number, param3:String) : void
      {
         ...
         if(_loc6_ >= 0)
         {
            ...
            this.releaseLinesFromTextBlock();
            _loc6_ = _loc6_ - (_loc8_.length - 1);
            if(_loc6_ >= 0 && _loc10_)
            {
               _loc11_ = TextLine(_loc8_[_loc8_.length - 1]);
               _loc12_ = _loc11_.specifiedWidth - _loc11_.unjustifiedTextWidth;
               _loc11_ = null;
               releaseTextLines(_loc8_);
               _loc13_ = this.getTruncationPosition(TextLine(textLines[_loc6_]),_loc12_,_loc7_);
               do
               {
                  _loc14_ = text.slice(0,_loc13_) + truncationIndicatorResource;
                  bounds.x = 0;
                  bounds.y = 0;
                  bounds.width = param1;
                  bounds.height = param2;
                  staticTextElement.text = _loc14_;
                  _loc15_ = this.createTextLinesFromTextBlock(staticTextBlock,textLines,bounds);
         ...
         if(!_loc5_)
         {
            ...
            bounds.x = 0;
            bounds.y = 0;
            bounds.width = _loc18_ + _loc19_;
            bounds.height = _loc20_ + _loc17_;
         }
         setIsTruncated(true);
      }
      ...
      private function truncateExplicitLineBreakText(param1:Number, param2:Number) : void
      {
         ...
         var _loc8_:int = 0;
         var _loc9_:String = null;
         var _loc10_:Vector.<DisplayObject> = null;
         staticTextElement.text = truncationIndicatorResource;
         ...
         this.releaseLinesFromTextBlock();
         var _loc5_:int = textLines.length;
         var _loc6_:int = 0;
         while(_loc6_ < _loc5_)
         {
            _loc7_ = textLines[_loc6_] as TextLine;
            if(_loc7_.x + _loc7_.width > param1)
            {
               _loc8_ = _loc7_.rawTextLength;
               while(--_loc8_ > 0)
               {
                  _loc9_ = text.substr(_loc7_.textBlockBeginIndex,_loc8_);
                  _loc9_ = _loc9_ + truncationIndicatorResource;
      ...
      private function computeLastAllowedLineIndex(param1:Number, param2:int) : int
      {
         ...
         var _loc3_:int = textLines.length - 1;
         if(_loc3_ < 0)
         {
            return _loc3_;
         }
         if(!isNaN(param1))
         {
            do
            {
               _loc4_ = TextLine(textLines[_loc3_]);
               if(_loc4_.y + _loc4_.descent <= param1)
               {
                  break;
               }
               _loc3_--;
      ...
      {
         param2--;
         var _loc3_:TextLine = TextLine(textLines[param1]);
         while(!(param2 >= _loc3_.textBlockBeginIndex && param2 < _loc3_.textBlockBeginIndex + _loc3_.rawTextLength))
         {
            ...
            {
               param1++;
               if(param1 >= textLines.length)
               {
                  return param2;
               }
            }
            _loc3_ = TextLine(textLines[param1]);
         }
         var _loc4_:int = _loc3_.getAtomIndexAtCharIndex(param2);
         var _loc5_:int = _loc3_.getAtomTextBlockBeginIndex(_loc4_);
         return _loc5_;
      }
