   ...
   public class TitleWindow extends Panel
   {
      ...
      override protected function getCurrentSkinState() : String
      {
         ...
         if(enabled && isPopUp && !this.active)
         {
            ...
            if(controlBarGroup)
            {
               if(BitFlagUtil.isSet(controlBarGroupProperties as uint,CONTROLBAR_PROPERTY_FLAG) && BitFlagUtil.isSet(controlBarGroupProperties as uint,VISIBLE_PROPERTY_FLAG))
               {
                  _loc1_ = _loc1_ + "WithControlBar";
               }
            }
            else if(controlBarGroupProperties.controlBarContent && controlBarGroupProperties.visible)
            {
               _loc1_ = _loc1_ + "WithControlBar";
            }
            return _loc1_;
      ...
      {
         var _loc2_:DisplayObject = getFocus() as DisplayObject;
         if(_loc2_ && contains(_loc2_))
         {
            if(stage)
            {
               stage.focus = null;
      ...
      {
         var _loc5_:TitleWindowBoundsEvent = null;
         ...
         if(!this.startBounds)
         {
            ...
            if(_loc5_.isDefaultPrevented())
            {
               ...
               _loc6_.removeEventListener(MouseEvent.MOUSE_MOVE,this.moveArea_mouseMoveHandler,true);
      ...
      {
         var _loc3_:TitleWindowBoundsEvent = null;
