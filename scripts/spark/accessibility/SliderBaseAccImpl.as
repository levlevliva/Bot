package spark.accessibility
{
   ...
   public class SliderBaseAccImpl extends AccImpl
   {
      ...
      {
         SliderBase.createAccessibilityImplementation = createAccessibilityImplementation;
      }
      ...
      override public function get_accRole(param1:uint) : uint
      {
         ...
         switch(param1)
         {
            case 1:
            case 3:
               _loc2_ = AccConst.ROLE_SYSTEM_PUSHBUTTON;
               break;
            case 2:
               _loc2_ = AccConst.ROLE_SYSTEM_INDICATOR;
               break;
            default:
               _loc2_ = role;
         }
      ...
      override public function accDoDefaultAction(param1:uint) : void
      {
         ...
         {
            _loc2_.value = _loc2_.value - _loc2_.stepSize;
         }
      ...
      override public function get_accValue(param1:uint) : String
      {
         ...
         var _loc2_:Number = SliderBase(master).value;
         _loc2_ = (_loc2_ - SliderBase(master).minimum) / (SliderBase(master).maximum - SliderBase(master).minimum) * 100;
