package spark.skins.spark
{
   ...
   public class DefaultButtonSkin extends SparkButtonSkin implements IStateClient2
   {
      ...
      private var _2123925202_DefaultButtonSkin_GradientEntry20:GradientEntry;
      
      private var _2123925203_DefaultButtonSkin_GradientEntry21:GradientEntry;
      ...
      public function DefaultButtonSkin()
      {
         ...
         this.minWidth = 21;
         this.minHeight = 21;
         this.mxmlContent = [this._DefaultButtonSkin_Rect1_i(),this._DefaultButtonSkin_Rect2_i(),this._DefaultButtonSkin_Rect3_i(),this._DefaultButtonSkin_Rect4_i(),this._DefaultButtonSkin_Rect8_i(),this._DefaultButtonSkin_Label1_i()];
         ...
         states = [new State({
            ...
            "overrides":[new AddItems().initializeFromObject({
               ...
               "target":"_DefaultButtonSkin_GradientEntry20",
               "name":"alpha",
               "value":0.6375
            }),new SetProperty().initializeFromObject({
               "target":"_DefaultButtonSkin_GradientEntry21",
               "name":"alpha",
               "value":0.85
            })]
         }),new State({
      ...
      override protected function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         _loc5_.redOffset = ((_loc4_ & 255 << 16) >> 16) * 0.24;
         _loc5_.greenOffset = ((_loc4_ & 255 << 8) >> 8) * 0.24;
      ...
      private function _DefaultButtonSkin_GradientEntry20_i() : GradientEntry
      {
         ...
         _loc1_.color = 0;
         _loc1_.alpha = 0.5625;
         this._DefaultButtonSkin_GradientEntry20 = _loc1_;
         BindingManager.executeBindings(this,"_DefaultButtonSkin_GradientEntry20",this._DefaultButtonSkin_GradientEntry20);
         return _loc1_;
      }
      ...
      private function _DefaultButtonSkin_GradientEntry21_i() : GradientEntry
      {
         ...
         _loc1_.color = 0;
         _loc1_.alpha = 0.75;
         this._DefaultButtonSkin_GradientEntry21 = _loc1_;
         BindingManager.executeBindings(this,"_DefaultButtonSkin_GradientEntry21",this._DefaultButtonSkin_GradientEntry21);
         return _loc1_;
      }
      ...
      [Bindable(event="propertyChange")]
      public function get _DefaultButtonSkin_GradientEntry20() : GradientEntry
      {
         return this._2123925202_DefaultButtonSkin_GradientEntry20;
      }
      
      public function set _DefaultButtonSkin_GradientEntry20(param1:GradientEntry) : void
      {
         var _loc2_:Object = this._2123925202_DefaultButtonSkin_GradientEntry20;
         if(_loc2_ !== param1)
         {
            this._2123925202_DefaultButtonSkin_GradientEntry20 = param1;
            if(this.hasEventListener("propertyChange"))
            {
               this.dispatchEvent(PropertyChangeEvent.createUpdateEvent(this,"_DefaultButtonSkin_GradientEntry20",_loc2_,param1));
            }
         }
      }
      
      [Bindable(event="propertyChange")]
      public function get _DefaultButtonSkin_GradientEntry21() : GradientEntry
      {
         return this._2123925203_DefaultButtonSkin_GradientEntry21;
      }
      
      public function set _DefaultButtonSkin_GradientEntry21(param1:GradientEntry) : void
      {
         var _loc2_:Object = this._2123925203_DefaultButtonSkin_GradientEntry21;
         if(_loc2_ !== param1)
         {
            this._2123925203_DefaultButtonSkin_GradientEntry21 = param1;
            if(this.hasEventListener("propertyChange"))
            {
               this.dispatchEvent(PropertyChangeEvent.createUpdateEvent(this,"_DefaultButtonSkin_GradientEntry21",_loc2_,param1));
            }
         }
      }
