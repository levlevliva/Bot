package spark.skins.spark
{
   ...
   public class ButtonSkin extends SparkButtonSkin implements IStateClient2
   {
      ...
      private var _470687729_ButtonSkin_GradientEntry20:GradientEntry;
      
      private var _470687728_ButtonSkin_GradientEntry21:GradientEntry;
      ...
      public function ButtonSkin()
      {
         ...
         this.minWidth = 21;
         this.minHeight = 21;
         this.mxmlContent = [this._ButtonSkin_Rect1_i(),this._ButtonSkin_Rect2_i(),this._ButtonSkin_Rect3_i(),this._ButtonSkin_Rect4_i(),this._ButtonSkin_Rect8_i(),this._ButtonSkin_Label1_i()];
         ...
         states = [new State({
            ...
            "overrides":[new AddItems().initializeFromObject({
               ...
               "target":"_ButtonSkin_GradientEntry20",
               "name":"alpha",
               "value":0.6375
            }),new SetProperty().initializeFromObject({
               "target":"_ButtonSkin_GradientEntry21",
               "name":"alpha",
               "value":0.85
            })]
         }),new State({
      ...
      private function _ButtonSkin_GradientEntry20_i() : GradientEntry
      {
         ...
         _loc1_.color = 0;
         _loc1_.alpha = 0.5625;
         this._ButtonSkin_GradientEntry20 = _loc1_;
         BindingManager.executeBindings(this,"_ButtonSkin_GradientEntry20",this._ButtonSkin_GradientEntry20);
         return _loc1_;
      }
      ...
      private function _ButtonSkin_GradientEntry21_i() : GradientEntry
      {
         ...
         _loc1_.color = 0;
         _loc1_.alpha = 0.75;
         this._ButtonSkin_GradientEntry21 = _loc1_;
         BindingManager.executeBindings(this,"_ButtonSkin_GradientEntry21",this._ButtonSkin_GradientEntry21);
         return _loc1_;
      }
      ...
      [Bindable(event="propertyChange")]
      public function get _ButtonSkin_GradientEntry20() : GradientEntry
      {
         return this._470687729_ButtonSkin_GradientEntry20;
      }
      
      public function set _ButtonSkin_GradientEntry20(param1:GradientEntry) : void
      {
         var _loc2_:Object = this._470687729_ButtonSkin_GradientEntry20;
         if(_loc2_ !== param1)
         {
            this._470687729_ButtonSkin_GradientEntry20 = param1;
            if(this.hasEventListener("propertyChange"))
            {
               this.dispatchEvent(PropertyChangeEvent.createUpdateEvent(this,"_ButtonSkin_GradientEntry20",_loc2_,param1));
            }
         }
      }
      
      [Bindable(event="propertyChange")]
      public function get _ButtonSkin_GradientEntry21() : GradientEntry
      {
         return this._470687728_ButtonSkin_GradientEntry21;
      }
      
      public function set _ButtonSkin_GradientEntry21(param1:GradientEntry) : void
      {
         var _loc2_:Object = this._470687728_ButtonSkin_GradientEntry21;
         if(_loc2_ !== param1)
         {
            this._470687728_ButtonSkin_GradientEntry21 = param1;
            if(this.hasEventListener("propertyChange"))
            {
               this.dispatchEvent(PropertyChangeEvent.createUpdateEvent(this,"_ButtonSkin_GradientEntry21",_loc2_,param1));
            }
         }
      }
