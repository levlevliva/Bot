package spark.skins.spark
{
   ...
   public class PanelSkin extends SparkSkin implements IBindingClient, IStateClient2
   {
      ...
      public function PanelSkin()
      {
         ...
         var _PanelSkin_Group3_factory:DeferredInstanceFromFunction = new DeferredInstanceFromFunction(this._PanelSkin_Group3_i);
         var _PanelSkin_Group7_factory:DeferredInstanceFromFunction = new DeferredInstanceFromFunction(this._PanelSkin_Group7_i);
         states = [new State({
            "name":"normal",
            "overrides":[]
         }),new State({
