package spark.skins.spark
{
   ...
   public class HSliderSkinInnerClass0 extends DataRenderer implements IBindingClient
   {
      ...
      public function HSliderSkinInnerClass0()
      {
         ...
         var bindings:Array = this._HSliderSkinInnerClass0_bindingsSetup();
         var watchers:Array = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_spark_skins_spark_HSliderSkinInnerClass0WatcherSetupUtil");
         ...
         {
            return HSliderSkinInnerClass0[param1];
         },bindings,watchers);
      ...
      {
         HSliderSkinInnerClass0._watcherSetupUtil = param1;
      }
      ...
      private function _HSliderSkinInnerClass0_Rect1_c() : Rect
      {
         ...
         _loc1_.right = 0;
         _loc1_.bottom = 0;
         _loc1_.fill = this._HSliderSkinInnerClass0_SolidColor1_c();
         _loc1_.filters = [this._HSliderSkinInnerClass0_DropShadowFilter1_c()];
      ...
      public function set outerDocument(param1:HSliderSkin) : void
      {
