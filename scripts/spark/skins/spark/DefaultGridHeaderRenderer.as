package spark.skins.spark
{
   ...
   public class DefaultGridHeaderRenderer extends GridItemRenderer implements IStateClient2
   {
      ...
      private var _627206627selectionIndicator:Rect;
      
      private var _2024155654selectionIndicatorFill:SolidColorStroke;
      ...
      public function DefaultGridHeaderRenderer()
      {
         ...
         this.minWidth = 21;
         this.minHeight = 21;
         this.mxmlContent = [this._DefaultGridHeaderRenderer_Rect1_i(),this._DefaultGridHeaderRenderer_Rect2_i(),this._DefaultGridHeaderRenderer_Rect3_i(),this._DefaultGridHeaderRenderer_Rect4_i(),this._DefaultGridHeaderRenderer_Rect8_i(),this._DefaultGridHeaderRenderer_HGroup1_c()];
      ...
      override public function prepare(param1:Boolean) : void
      {
         ...
         _loc2_ = this.column;
         var _loc3_:DataGrid = _loc2_ && _loc2_.grid?_loc2_.grid.dataGrid:null;
         var _loc4_:GridColumnHeaderGroup = !!_loc3_?_loc3_.columnHeaderGroup:null;
         if(this.sortIndicator && _loc4_)
         {
         ...
         if(this.selectionIndicator && _loc4_)
         {
            this.selectionIndicator.visible = _loc4_.highlightSelectedColumn && _loc4_.selectedColumnIndex == _loc2_.columnIndex;
         }
      }
            ...
            if(_loc3_ != DEFAULT_COLOR || this.colorized)
            {
               ...
               if(_loc4_ && _loc4_.length > 0)
               {
                  ...
                  while(_loc5_ < _loc4_.length)
                  {
                     ...
                     if(_loc6_ && (_loc6_ is DisplayObject || _loc6_ is GraphicElement))
                     {
      ...
      private function _DefaultGridHeaderRenderer_Rect8_i() : Rect
      {
         var _loc1_:Rect = new Rect();
         _loc1_.left = 1;
         _loc1_.right = 1;
         ...
         _loc1_.stroke = this._DefaultGridHeaderRenderer_SolidColorStroke1_i();
         _loc1_.initialized(this,"selectionIndicator");
         this.selectionIndicator = _loc1_;
         BindingManager.executeBindings(this,"selectionIndicator",this.selectionIndicator);
         return _loc1_;
      }
      
      private function _DefaultGridHeaderRenderer_SolidColorStroke1_i() : SolidColorStroke
      {
      ...
      [Bindable(event="propertyChange")]
      public function get selectionIndicator() : Rect
      {
         return this._627206627selectionIndicator;
      }
      
      public function set selectionIndicator(param1:Rect) : void
      {
      ...
      [Bindable(event="propertyChange")]
      public function get selectionIndicatorFill() : SolidColorStroke
      {
         return this._2024155654selectionIndicatorFill;
      }
      
      public function set selectionIndicatorFill(param1:SolidColorStroke) : void
      {
