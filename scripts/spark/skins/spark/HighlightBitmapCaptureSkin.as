package spark.skins.spark
{
   ...
   public class HighlightBitmapCaptureSkin extends UIComponent
   {
      ...
      override protected function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         if(this.target.method_296.matrix3D)
         {
            transform3D = this.target.method_296.matrix3D;
            this.target.method_296.matrix3D = null;
         }
         ...
         if(transform3D)
         {
            this.target.method_296.matrix3D = transform3D;
         }
