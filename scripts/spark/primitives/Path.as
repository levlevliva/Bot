package spark.primitives
{
   ...
   public class Path extends FilledElement
   {
      ...
      private function getBoundingBoxWithStroke(param1:Number, param2:Number, param3:Matrix) : Rectangle
      {
         ...
         this._boundingBoxCached = this.computeBoundsWithStroke(this._boundingBoxWidthParamCached,this._boundingBoxHeightParamCached,param3);
      ...
      mx_internal function computeBoundsWithStroke(param1:Number, param2:Number, param3:Matrix) : Rectangle
      {
         ...
         var _loc15_:int = 0;
         var _loc19_:PathSegment = null;
         var _loc20_:PathSegment = null;
         var _loc21_:PathSegment = null;
         var _loc4_:Rectangle = this.getBounds();
         var _loc5_:Number = _loc4_.width == 0?Number(1):Number(param1 / _loc4_.width);
         var _loc6_:Number = _loc4_.height == 0?Number(1):Number(param2 / _loc4_.height);
         ...
         var _loc8_:IStroke = this.stroke;
         if(!_loc8_ || !this.segments)
         {
            return _loc7_;
         }
         ...
         while(true)
         {
            ...
            _loc19_ = _loc10_[_loc14_];
            if(_loc19_ is MoveSegment)
            {
               _loc18_ = _loc14_ + 1;
               _loc16_ = _loc19_.x;
               _loc17_ = _loc19_.y;
            ...
            else
            {
               ...
               _loc20_ = _loc10_[_loc15_];
               if(!(_loc20_ is MoveSegment))
               {
               ...
               _loc14_ = _loc14_ > _loc15_?int(_loc14_ + 1):int(_loc15_);
            }
         }
         return _loc7_;
      }
      ...
      private function addMiterLimitStrokeToBounds(param1:PathSegment, param2:PathSegment, param3:PathSegment, param4:Number, param5:Number, param6:Number, param7:Number, param8:Matrix, param9:Rectangle) : void
      {
         ...
         _loc10_ = MatrixUtil.transformPoint(param2.x * param6,param2.y * param7,param8).clone();
         ...
         _loc13_.y = -_loc13_.y;
         _loc14_.normalize(1);
         var _loc15_:Point = new Point((_loc14_.x - _loc13_.x) * 0.5,(_loc14_.y - _loc13_.y) * 0.5);
         var _loc16_:Number = _loc15_.length;
         if(Math.abs(_loc16_) < 1.0e-9)
         {
            return;
         }
         var _loc17_:Point = new Point(-0.5 * (_loc13_.x + _loc14_.x),-0.5 * (_loc13_.y + _loc14_.y));
         if(_loc17_.length == 0)
         {
            return;
         }
      ...
      private function getBoundsAtSize(param1:Number, param2:Number, param3:Matrix) : Rectangle
      {
         ...
         if(param3)
         {
            _loc7_ = MatrixUtil.fitBounds(param1,param2,param3,explicitWidth,explicitHeight,_loc5_,_loc6_,minWidth,minHeight,maxWidth,maxHeight);
            if(_loc7_)
            {
               _loc5_ = _loc7_.x;
               _loc6_ = _loc7_.y;
      ...
      override public function getLayoutBoundsX(param1:Boolean = true) : Number
      {
         ...
         var _loc2_:Matrix = getComplexMatrix(param1);
         if(!_loc2_ && !stroke)
         {
            if(measuredX == 0)
            {
            ...
            _loc4_ = _loc3_.width == 0 || _width == 0?Number(1):Number(_width / _loc3_.width);
            return this.x + measuredX * _loc4_;
         }
         return this.getBoundingBoxWithStroke(_width,_height,_loc2_).x + (!!_loc2_?0:this.x);
      }
      ...
      override public function getLayoutBoundsY(param1:Boolean = true) : Number
      {
         ...
         if(!_loc2_ && !stroke)
         {
            ...
            _loc3_ = this.getBounds();
            _loc4_ = _loc3_.height == 0 || _height == 0?Number(1):Number(_height / _loc3_.height);
            return this.y + measuredY * _loc4_;
         }
         return this.getBoundingBoxWithStroke(_width,_height,_loc2_).y + (!!_loc2_?0:this.y);
      }
      ...
      private function setLayoutBoundsTransformed(param1:Number, param2:Number, param3:Matrix) : void
      {
         ...
         var _loc7_:Point = null;
         var _loc8_:* = false;
         var _loc4_:Point = this.fitLayoutBoundsIterative(param1,param2,param3);
         if(!_loc4_ && !isNaN(param1) && !isNaN(param2))
         {
            _loc5_ = this.fitLayoutBoundsIterative(NaN,param2,param3);
            _loc6_ = this.fitLayoutBoundsIterative(param1,NaN,param3);
            if(_loc5_ && this.getBoundingBoxWithStroke(_loc5_.x,_loc5_.y,param3).width > param1)
            {
               _loc5_ = null;
            }
            if(_loc6_ && this.getBoundingBoxWithStroke(_loc6_.x,_loc6_.y,param3).height > param2)
            {
               _loc6_ = null;
            }
            if(_loc5_ && _loc6_)
            {
               ...
               _loc8_ = Math.abs(_loc7_.x * _loc5_.y - _loc7_.y * _loc5_.x) * _loc6_.y < Math.abs(_loc7_.x * _loc6_.y - _loc7_.y * _loc6_.x) * _loc5_.y;
               if(_loc8_)
               {
                  _loc4_ = _loc5_;
               }
         ...
         if(_loc4_)
         {
            setActualSize(_loc4_.x,_loc4_.y);
         }
         else
         {
      ...
      override public function setLayoutBoundsSize(param1:Number, param2:Number, param3:Boolean = true) : void
      {
         ...
         if(!isNaN(param1) && !isNaN(param2))
         {
            _loc11_ = this.fitLayoutBoundsIterative(param1,param2,new Matrix());
            if(_loc11_)
            {
               setActualSize(_loc11_.x,_loc11_.y);
               return;
            }
      ...
      override protected function beginDraw(param1:Graphics) : void
      {
         ...
         var _loc3_:Number = _loc2_.width == 0?Number(1):Number(width / _loc2_.width);
         var _loc4_:Number = _loc2_.height == 0?Number(1):Number(height / _loc2_.height);
         ...
         if(stroke)
         {
            _loc7_ = this.getStrokeBounds();
            _loc7_.offsetPoint(_loc5_);
      ...
      override protected function draw(param1:Graphics) : void
      {
         ...
         if(this.graphicsPathChanged)
         {
            ...
            _loc3_ = _loc2_.width == 0?Number(1):Number(width / _loc2_.width);
            _loc4_ = _loc2_.height == 0?Number(1):Number(height / _loc2_.height);
            if(this.segments)
            {
               this.segments.generateGraphicsPath(this.graphicsPath,drawX,drawY,_loc3_,_loc4_);
            }
            this.graphicsPathChanged = false;
         }
         param1.drawPath(this.graphicsPath.commands,this.graphicsPath.data,this.winding);
      }
...
class PathSegmentsCollection
{
   ...
   {
      var _loc2_:Vector.<PathSegment> = null;
      var _loc4_:Number = NaN;
      ...
      while(true)
      {
         ...
         _loc4_ = param1.charCodeAt(this._charPos++);
         if(_loc4_ >= 48 && _loc4_ < 58 || (_loc4_ == 43 || _loc4_ == 45) || _loc4_ == 46)
         {
            _loc4_ = _loc6_;
            this._charPos--;
         }
         ...
         switch(_loc4_)
         {
            case 99:
            case 67:
               _loc13_ = this.getNumber(_loc5_,_loc7_,param1);
               _loc14_ = this.getNumber(_loc5_,_loc8_,param1);
               _loc15_ = this.getNumber(_loc5_,_loc7_,param1);
               _loc16_ = this.getNumber(_loc5_,_loc8_,param1);
               _loc11_ = this.getNumber(_loc5_,_loc7_,param1);
               _loc12_ = this.getNumber(_loc5_,_loc8_,param1);
            ...
            case 77:
               ...
               _loc7_ = _loc11_;
               _loc8_ = _loc12_;
               _loc6_ = _loc4_ == 109?Number(108):Number(76);
   ...
   {
      var _loc7_:PathSegment = null;
      var _loc8_:Rectangle = null;
      var _loc11_:PathSegment = null;
      var _loc12_:Number = NaN;
      var _loc13_:Number = NaN;
      var _loc4_:Rectangle = this.getBounds();
      var _loc5_:Number = _loc4_.width == 0?Number(1):Number(param1 / _loc4_.width);
      var _loc6_:Number = _loc4_.height == 0?Number(1):Number(param2 / _loc4_.height);
      var _loc9_:int = this._segments.length;
      var _loc10_:int = 0;
      while(_loc10_ < _loc9_)
      {
         _loc11_ = this._segments[_loc10_];
         _loc8_ = _loc11_.getBoundingBox(_loc7_,_loc5_,_loc6_,param3,_loc8_);
         _loc7_ = _loc11_;
         _loc10_++;
      }
      if(!_loc8_)
      {
         _loc12_ = !!param3?Number(param3.tx):Number(0);
         _loc13_ = !!param3?Number(param3.ty):Number(0);
   ...
   {
      var _loc6_:PathSegment = null;
      var _loc7_:PathSegment = null;
      param1.commands = null;
      param1.data = null;
      param1.moveTo(param2,param3);
      var _loc8_:int = this._segments.length;
      var _loc9_:int = 0;
      while(_loc9_ < _loc8_)
      {
         _loc7_ = _loc6_;
         _loc6_ = this._segments[_loc9_];
         _loc6_.draw(param1,param2,param3,param4,param5,_loc7_);
         _loc9_++;
      }
   }
   ...
   private function getNumber(param1:Boolean, param2:Number, param3:String) : Number
   {
      ...
      var _loc4_:int = this._charPos;
      var _loc5_:Boolean = false;
      var _loc6_:Boolean = false;
      var _loc7_:Number = param3.charCodeAt(this._charPos);
      if(_loc7_ == 43 || _loc7_ == 45)
      {
         _loc5_ = true;
         this._charPos++;
      }
      ...
      while(this._charPos < this._dataLength)
      {
         _loc7_ = param3.charCodeAt(this._charPos);
         if(_loc7_ >= 48 && _loc7_ < 58)
         {
            _loc6_ = true;
         }
         else if(_loc7_ == 46 && _loc8_ == -1)
         {
            _loc8_ = this._charPos;
         }
         else
         {
            break;
      ...
      this._charPos = _loc9_;
      return !!param1?Number(_loc11_ + param2):Number(_loc11_);
   }
}
...
class LineSegment extends PathSegment
{
   ...
   {
      param1.lineTo(param2 + x * param4,param3 + y * param5);
   }
   ...
   override public function getBoundingBox(param1:PathSegment, param2:Number, param3:Number, param4:Matrix, param5:Rectangle) : Rectangle
   {
      ...
      _loc8_ = MatrixUtil.transformPoint(x * param2,y * param3,param4);
      var _loc6_:Number = _loc8_.x;
      ...
      _loc8_ = MatrixUtil.transformPoint(!!param1?Number(param1.x * param2):Number(0),!!param1?Number(param1.y * param3):Number(0),param4);
   ...
   {
      var _loc7_:Point = MatrixUtil.transformPoint(!!param1?Number(param1.x * param3):Number(0),!!param1?Number(param1.y * param4):Number(0),param5).clone();
      var _loc8_:Point = MatrixUtil.transformPoint(x * param3,y * param4,param5);
...
class MoveSegment extends PathSegment
{
   ...
   override public function draw(param1:GraphicsPath, param2:Number, param3:Number, param4:Number, param5:Number, param6:PathSegment) : void
   {
      param1.moveTo(param2 + x * param4,param3 + y * param5);
   }
}
...
class CubicBezierSegment extends PathSegment
{
   ...
   override public function getBoundingBox(param1:PathSegment, param2:Number, param3:Number, param4:Matrix, param5:Rectangle) : Rectangle
   {
      ...
      param5 = MatrixUtil.getQBezierSegmentBBox(!!param1?Number(param1.x):Number(0),!!param1?Number(param1.y):Number(0),_loc6_.control1.x,_loc6_.control1.y,_loc6_.anchor1.x,_loc6_.anchor1.y,param2,param3,param4,param5);
      ...
      param5 = MatrixUtil.getQBezierSegmentBBox(_loc6_.anchor3.x,_loc6_.anchor3.y,_loc6_.control4.x,_loc6_.control4.y,_loc6_.anchor4.x,_loc6_.anchor4.y,param2,param3,param4,param5);
      return param5;
   }
   ...
   override public function getTangent(param1:PathSegment, param2:Boolean, param3:Number, param4:Number, param5:Matrix, param6:Point) : void
   {
      ...
      var _loc8_:Point = MatrixUtil.transformPoint(!!param1?Number(param1.x * param3):Number(0),!!param1?Number(param1.y * param4):Number(0),param5).clone();
   ...
   private function getQuadraticPoints(param1:PathSegment) : QuadraticPoints
   {
      ...
      var _loc2_:Point = new Point(!!param1?Number(param1.x):Number(0),!!param1?Number(param1.y):Number(0));
      ...
      var _loc6_:Point = Point.interpolate(_loc4_,_loc2_,3 / 4);
      var _loc7_:Point = Point.interpolate(_loc5_,_loc3_,3 / 4);
      var _loc8_:Number = (_loc3_.x - _loc2_.x) / 16;
      var _loc9_:Number = (_loc3_.y - _loc2_.y) / 16;
      this._qPts = new QuadraticPoints();
      this._qPts.control1 = Point.interpolate(_loc4_,_loc2_,3 / 8);
      this._qPts.control2 = Point.interpolate(_loc7_,_loc6_,3 / 8);
      this._qPts.control2.x = this._qPts.control2.x - _loc8_;
      this._qPts.control2.y = this._qPts.control2.y - _loc9_;
      this._qPts.control3 = Point.interpolate(_loc6_,_loc7_,3 / 8);
      this._qPts.control3.x = this._qPts.control3.x + _loc8_;
      this._qPts.control3.y = this._qPts.control3.y + _loc9_;
      this._qPts.control4 = Point.interpolate(_loc5_,_loc3_,3 / 8);
...
class QuadraticBezierSegment extends PathSegment
{
   ...
   override public function draw(param1:GraphicsPath, param2:Number, param3:Number, param4:Number, param5:Number, param6:PathSegment) : void
   {
      param1.curveTo(param2 + this.control1X * param4,param3 + this.control1Y * param5,param2 + x * param4,param3 + y * param5);
   }
   
   override public function getTangent(param1:PathSegment, param2:Boolean, param3:Number, param4:Number, param5:Matrix, param6:Point) : void
   {
      var _loc7_:Point = MatrixUtil.transformPoint(!!param1?Number(param1.x * param3):Number(0),!!param1?Number(param1.y * param4):Number(0),param5).clone();
      var _loc8_:Point = MatrixUtil.transformPoint(this.control1X * param3,this.control1Y * param4,param5).clone();
      var _loc9_:Point = MatrixUtil.transformPoint(x * param3,y * param4,param5).clone();
      getQTangent(_loc7_.x,_loc7_.y,_loc8_.x,_loc8_.y,_loc9_.x,_loc9_.y,param2,param6);
   }
   
   override public function getBoundingBox(param1:PathSegment, param2:Number, param3:Number, param4:Matrix, param5:Rectangle) : Rectangle
   {
      return MatrixUtil.getQBezierSegmentBBox(!!param1?Number(param1.x):Number(0),!!param1?Number(param1.y):Number(0),this.control1X,this.control1Y,x,y,param2,param3,param4,param5);
   }
}
