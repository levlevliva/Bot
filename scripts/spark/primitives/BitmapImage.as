package spark.primitives
{
   ...
   public class BitmapImage extends GraphicElement
   {
      ...
      public var imageDecodingPolicy:String = "onDemand";
      ...
      protected static function resample(param1:BitmapData, param2:uint, param3:uint) : BitmapData
      {
         ...
         while(Math.round(_loc11_ * 1000) >= Math.round(_loc4_ * 1000))
         {
            ...
            _loc10_.draw(_loc5_,new Matrix(0.5,0,0,0.5),null,null,null,true);
            _loc5_.dispose();
            _loc5_ = _loc10_;
            _loc11_ = _loc11_ * 0.5;
         }
      ...
      override protected function measure() : void
      {
         ...
         if("applicationDPI" in _loc1_ && "runtimeDPI" in _loc1_ && this.source is MultiDPIBitmapSource)
         {
            this.dpiScale = _loc1_.runtimeDPI / _loc1_.applicationDPI;
         }
         if(this.loadedContent)
         {
            ...
            if(this.dpiScale != 1)
            {
               measuredWidth = measuredWidth / this.dpiScale;
               measuredHeight = measuredHeight / this.dpiScale;
            }
         }
         ...
         {
            _loc2_ = !(this._source == null || this._source == "" || this.loadFailed);
            _loc3_ = !!_loc2_?Number(measuredWidth):Number(0);
            _loc4_ = !!_loc2_?Number(measuredHeight):Number(0);
            measuredWidth = !isNaN(this._preliminaryWidth) && _loc3_ == 0?Number(this._preliminaryWidth):Number(_loc3_);
            measuredHeight = !isNaN(this._preliminaryHeight) && _loc4_ == 0?Number(this._preliminaryHeight):Number(_loc4_);
            return;
         }
      ...
      override protected function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         var _loc10_:Number = 1 / this.dpiScale;
         var _loc11_:Number = 1 / this.dpiScale;
      ...
      mx_internal function applySource() : void
      {
         ...
         {
            _loc1_ = (_loc1_ as MultiDPIBitmapSource).getMultiSource();
         }
      ...
      protected function hasImageDecodingPolicy(param1:LoaderContext) : Boolean
      {
         if(!this._haveCachedImageDecodePolicy)
         {
            this._cachedImageDecodePolicy = "imageDecodingPolicy" in param1;
            this._haveCachedImageDecodePolicy = true;
         }
         return this._cachedImageDecodePolicy;
      }
      ...
      mx_internal function loadExternal(param1:Object) : void
      {
         ...
         else
         {
            ...
            if(this.hasImageDecodingPolicy(loaderContext))
            {
               loaderContext["imageDecodingPolicy"] = this.imageDecodingPolicy;
            }
