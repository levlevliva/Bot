package com.greensock.loading.core
{
   ...
   public class LoaderItem extends LoaderCore
   {
      ...
      protected final function _prepRequest() : void
      {
      ...
      protected final function _setRequestURL(param1:URLRequest, param2:String, param3:String = "") : void
      {
      ...
      protected final function _httpStatusHandler(param1:Event) : void
      {
