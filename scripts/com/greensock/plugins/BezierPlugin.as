package com.greensock.plugins
{
   ...
   import com.bigpoint.seafight.view.popups.guildmenu.player.vo.BasicInfoVo;
   ...
   public class BezierPlugin extends TweenPlugin
   {
      ...
      protected final function init(param1:TweenLite, param2:Array, param3:Boolean) : void
      {
         var _loc6_:int = 0;
         var _loc7_:* = null;
