package com.greensock
{
   ...
   public final class TweenMax extends TweenLite implements IEventDispatcher
   {
      ...
      public final function updateTo(param1:Object, param2:Boolean = false) : void
      {
         var _loc4_:* = null;
      ...
      public final function setDestination(param1:String, param2:*, param3:Boolean = true) : void
      {
         var _loc4_:Object = {};
      ...
      public final function killProperties(param1:Array) : void
      {
         var _loc2_:Object = {};
      ...
      override public function renderTime(param1:Number, param2:Boolean = false, param3:Boolean = false) : void
      {
         ...
         else if(param1 <= 0)
         {
            ...
            this.ratio = 0;
            this.cachedTotalTime = this.cachedTime = _loc15_;
      ...
      protected final function initDispatcher() : void
      {
