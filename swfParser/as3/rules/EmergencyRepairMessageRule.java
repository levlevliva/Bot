 ...
 */
public class EmergencyRepairMessageRule extends Rule {
    ...
    public void process(AS3Parser context) {
        /*get player manager*/
        String[] result = context.findFileByString("function onEmergencyRepairsClick");
        String searchSrc = result[0];

        String methodSrc = context.findFunctionByString(searchSrc, "function onEmergencyRepairsClick");
    ...
    public void export() {
        try {
            Files.write(Paths.get("emergency_repair_message.json"), jsonString.getBytes("UTF8"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
